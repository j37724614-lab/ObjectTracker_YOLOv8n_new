...
# 10 "../../../../Library/StdDriver/src/spi.c"
...
# 11 "../../../../Library/StdDriver/src/spi.c" 2
# 23 "../../../../Library/StdDriver/src/spi.c"
...
static void SPI_SetPCLKSrc(SPI_T *spi)
{
    ...
    if (spi == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00240000UL) + 0x0B000UL)))
    {

        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPISEL = (((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPISEL & (~(0x7ul << (0)))) | (0x3UL << (0));
    }
    else if (spi == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00280000UL) + 0x0B000UL)))
    {

        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPISEL = (((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPISEL & (~(0x7ul << (4)))) | (0x3UL << (4));
    }
    else if (spi == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00240000UL) + 0x0C000UL)))
    {

        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPISEL = (((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPISEL & (~(0x7ul << (8)))) | (0x3UL << (8));
    }
    else if (spi == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00280000UL) + 0x0C000UL)))
    {

        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPISEL = (((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPISEL & (~(0x7ul << (12)))) | (0x3UL << (12));
    }
}
...
static uint32_t SPI_GetModuleClkSrcFreq(SPI_T *spi)
{
    ...
    if (spi == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00240000UL) + 0x0B000UL)))
        u32SPIClkSrcSel = ((((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPISEL & (0x7ul << (0))) >> (0));
    else if (spi == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00280000UL) + 0x0B000UL)))
        u32SPIClkSrcSel = ((((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPISEL & (0x7ul << (0))) >> (0));
    else if (spi == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00240000UL) + 0x0C000UL)))
        u32SPIClkSrcSel = ((((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPISEL & (0x7ul << (8))) >> (8));
    else if (spi == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00280000UL) + 0x0C000UL)))
        u32SPIClkSrcSel = ((((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPISEL & (0x7ul << (12))) >> (12));
    else
        u32SPIClkSrcSel = (0x0UL);


    switch (u32SPIClkSrcSel)
    {
        case (0x0UL):
            u32RetValue = (24000000UL);
            break;

        case (0x1UL):
            u32RetValue = (CLK_GetAPLL1ClockFreq() >> 1);
            break;

        case (0x2UL):
            u32RetValue = (CLK_GetAPLL0ClockFreq() >> 1);
            break;
        ...
        case (0x4UL):
            u32RetValue = (12000000UL);
            break;

        case (0x5UL):
            u32RetValue = (48000000UL);
            break;
...
# 166 "../../../../Library/StdDriver/src/spi.c"
uint32_t SPI_Open(SPI_T *spi, uint32_t u32MasterSlave, uint32_t u32SPIMode, uint32_t u32DataWidth, uint32_t u32BusClock)
{
...
void SPI_Close(SPI_T *spi)
{
    ...
    if (spi == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00240000UL) + 0x0B000UL)))
    {
        SYS_ResetModule(((0x2ACUL<<20) | (0)));
    }
    else if (spi == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00280000UL) + 0x0B000UL)))
    {
        SYS_ResetModule(((0x2ACUL<<20) | (1)));
    }
    else if (spi == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00240000UL) + 0x0C000UL)))
    {
        SYS_ResetModule(((0x2ACUL<<20) | (2)));
    }
    else
    {
        SYS_ResetModule(((0x2ACUL<<20) | (3)));
    }
...
# 288 "../../../../Library/StdDriver/src/spi.c"
void SPI_EnableAutoSS(SPI_T *spi, uint32_t u32SSPinMask, uint32_t u32ActiveLevel)
{
...
uint32_t SPI_SetBusClock(SPI_T *spi, uint32_t u32BusClock)
{
    ...
    else if (u32BusClock == 0U)
    {
        ...
        u32RetValue = (u32ClkSrc / (((0x1fful << (0)) >> (0)) + 1U));
    }
    else
    {
...
# 367 "../../../../Library/StdDriver/src/spi.c"
void SPI_SetFIFO(SPI_T *spi, uint32_t u32TxThreshold, uint32_t u32RxThreshold)
{
...
# 414 "../../../../Library/StdDriver/src/spi.c"
void SPI_EnableInt(SPI_T *spi, uint32_t u32Mask)
{
...
# 496 "../../../../Library/StdDriver/src/spi.c"
void SPI_DisableInt(SPI_T *spi, uint32_t u32Mask)
{
...
# 579 "../../../../Library/StdDriver/src/spi.c"
uint32_t SPI_GetIntFlag(SPI_T *spi, uint32_t u32Mask)
{
...
# 683 "../../../../Library/StdDriver/src/spi.c"
void SPI_ClearIntFlag(SPI_T *spi, uint32_t u32Mask)
{
    if (u32Mask & (0x001U))
    {
...
# 744 "../../../../Library/StdDriver/src/spi.c"
uint32_t SPI_GetStatus(SPI_T *spi, uint32_t u32Mask)
{
...
# 826 "../../../../Library/StdDriver/src/spi.c"
uint32_t SPI_GetStatus2(SPI_T *spi, uint32_t u32Mask)
{
    uint32_t u32TmpStatus;
    uint32_t u32Number = 0UL;

    u32TmpStatus = ((spi->STATUS2 & (0x3ful << (24))) >> (24));


    if ((u32Mask & (0x01U)) && (u32TmpStatus))
    {
...
# 883 "../../../../Library/StdDriver/src/spi.c"
uint32_t SPII2S_Open(SPI_T *i2s, uint32_t u32MasterSlave, uint32_t u32SampleRate, uint32_t u32WordWidth, uint32_t u32Channels, uint32_t u32DataFormat)
{
    ...
    else
    {
        ...
        if (i2s == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00240000UL) + 0x0B000UL)))
        {

            i2s->I2SCTL |= ((0x1ul << (2)) | (0x1ul << (1)) | (0x1ul << (0)));
        }
        else if (i2s == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00280000UL) + 0x0B000UL)))
        {

            i2s->I2SCTL |= ((0x1ul << (2)) | (0x1ul << (1)) | (0x1ul << (0)));
        }
        else if (i2s == ((SPI_T *) ((((uint32_t) 0x40000000UL) + 0x00240000UL) + 0x0C000UL)))
        {
...
# 977 "../../../../Library/StdDriver/src/spi.c"
void SPII2S_EnableInt(SPI_T *i2s, uint32_t u32Mask)
{
...
# 1043 "../../../../Library/StdDriver/src/spi.c"
void SPII2S_DisableInt(SPI_T *i2s, uint32_t u32Mask)
{
...
# 1102 "../../../../Library/StdDriver/src/spi.c"
uint32_t SPII2S_EnableMCLK(SPI_T *i2s, uint32_t u32BusClock)
{
    uint32_t u32Divider;
...
# 1159 "../../../../Library/StdDriver/src/spi.c"
void SPII2S_SetFIFO(SPI_T *i2s, uint32_t u32TxThreshold, uint32_t u32RxThreshold)
{
