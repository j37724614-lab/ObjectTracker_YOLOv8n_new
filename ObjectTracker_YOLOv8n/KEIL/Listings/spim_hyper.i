# 1 "../../../../Library/StdDriver/src/spim_hyper.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/spim_hyper.c" 2
...
# 10 "../../../../Library/StdDriver/src/spim_hyper.c" 2
...
# 11 "../../../../Library/StdDriver/src/spim_hyper.c" 2
...
# 12 "../../../../Library/StdDriver/src/spim_hyper.c" 2
# 111 "../../../../Library/StdDriver/src/spim_hyper.c"
static int32_t spim_hyper_wait_cmdidle(SPIM_T *spim)
{
    volatile int32_t i32TimeOutCnt = (int32_t)SystemCoreClock;

    while (spim->HYPER_CMD != (0x00000000))
    {
        if (--i32TimeOutCnt <= 0)
        {
            return (-2L);
...
# 200 "../../../../Library/StdDriver/src/spim_hyper.c"
void SPIM_HYPER_Init(SPIM_T *spim, uint32_t u32HyperMode, uint32_t u32Div)
{
    ...
    do { (spim->CTL0 = ((spim->CTL0 & ~((0x3ul << (2)))) | ((u32HyperMode) << (2)))); SPIM_HYPER_DISABLE_CIPHER(spim); }while(0);


    (spim->CTL1 = ((spim->CTL1 & ~((0xfffful << (16)))) | (((((u32Div != 1) && (u32Div != 2)) ? 1 : u32Div)) << (16))));
}
# 221 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_WaitSPIMENDone(SPIM_T *spim, uint32_t u32IsSync)
{
    volatile int32_t i32TimeOutCount = (int32_t)SystemCoreClock;


    (spim->CTL1 = ((spim->CTL1 & ~((0x1ul << (0)))) | (0x1ul << (0))));

    if (u32IsSync)
    {
        while ((((spim->HYPER_INTEN & (0x1ul << (0))) >> (0)) ? ((spim->HYPER_INTEN & (0x1ul << (0))) >> (0)) : ((spim->CTL1 & (0x1ul << (0))) >> (0))))
        {
            if (--i32TimeOutCount <= 0)
            {
                return (-2L);
...
# 249 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Reset(SPIM_T *spim)
{
    volatile uint32_t u32Delay = 0;
    int32_t i32Ret = (-1L);

    spim->HYPER_CMD = (0x00000001);
...
# 271 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_ExitHSAndDPD(SPIM_T *spim)
{
    spim->HYPER_CMD = (0x00000005);

    return spim_hyper_wait_cmdidle(spim);
}
# 291 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_ReadHyperRAMReg(SPIM_T *spim, uint32_t u32Addr)
{
    ...
    spim->HYPER_CMD = (0x00000002);

    spim_hyper_wait_cmdidle(spim);

    return (spim->HYPER_RDATA & 0xFFFF);
}
# 324 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_WriteHyperRAMReg(SPIM_T *spim, uint32_t u32Addr, uint32_t u32Value)
{
    if ((u32Addr != (0x00000000)) &&
            (u32Addr != (0x00000002)) &
    ...
    spim->HYPER_CMD = (0x00000007);

    spim_hyper_wait_cmdidle(spim);

    return ( 0L);
}
# 353 "../../../../Library/StdDriver/src/spim_hyper.c"
uint16_t SPIM_HYPER_Read1Word(SPIM_T *spim, uint32_t u32Addr)
{
    spim->HYPER_ADR = u32Addr;

    spim->HYPER_CMD = (0x00000008);
...
uint32_t SPIM_HYPER_Read2Word(SPIM_T *spim, uint32_t u32Addr)
{
    ...
    spim->HYPER_CMD = (0x00000009);

    spim_hyper_wait_cmdidle(spim);

    return (uint32_t)(spim->HYPER_RDATA & 0xFFFFFFFF);
}
# 390 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Write1Byte(SPIM_T *spim, uint32_t u32Addr, uint8_t u8Data)
{
    (spim->HYPER_WDATA &= ~(0xFFFFFFFF));
    ...
    spim->HYPER_CMD = (0x0000000C);

    return spim_hyper_wait_cmdidle(spim);
}
# 411 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Write2Byte(SPIM_T *spim, uint32_t u32Addr, uint16_t u16Data)
{
    (spim->HYPER_WDATA &= ~(0xFFFFFFFF));
    ...
    spim->HYPER_CMD = (0x0000000D);

    return spim_hyper_wait_cmdidle(spim);
}
# 432 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Write3Byte(SPIM_T *spim, uint32_t u32Addr, uint32_t u32Data)
{
    (spim->HYPER_WDATA &= ~(0xFFFFFFFF));
    ...
    spim->HYPER_CMD = (0x0000000E);

    return spim_hyper_wait_cmdidle(spim);
}
# 453 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Write4Byte(SPIM_T *spim, uint32_t u32Addr, uint32_t u32Data)
{
    (spim->HYPER_WDATA &= ~(0xFFFFFFFF));
    ...
    spim->HYPER_CMD = (0x0000000F);

    return spim_hyper_wait_cmdidle(spim);
}
# 476 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_DMAWrite(SPIM_T *spim, uint32_t u32Addr, uint8_t *pu8WrBuf, uint32_t u32NTx)
{
    SPIM_HYPER_SET_OPMODE(spim, (1UL));

    spim->SRAMADDR = (uint32_t)pu8WrBuf;
    spim->DMACNT = u32NTx;
    spim->FADDR = u32Addr;

    return SPIM_HYPER_WaitSPIMENDone(spim, (0x01UL));
}
# 498 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_DMARead(SPIM_T *spim, uint32_t u32Addr, uint8_t *pu8RdBuf, uint32_t u32NRx)
{
    SPIM_HYPER_SET_OPMODE(spim, (2UL));
    spim->SRAMADDR = (uint32_t)pu8RdBuf;
    spim->DMACNT = u32NRx;
    spim->FADDR = u32Addr;
...
void SPIM_HYPER_EnterDirectMapMode(SPIM_T *spim)
{
    SPIM_HYPER_SET_OPMODE(spim, (3UL));
}
...
void SPIM_HYPER_ExitDirectMapMode(SPIM_T *spim)
{
    SPIM_HYPER_SET_OPMODE(spim, (0UL));
}
# 538 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_INIT_DLL(SPIM_T *spim)
{
    volatile int32_t i32TimeoutCount;
    uint32_t u32BusClkHz = CLK_GetSCLKFreq() / (((spim->CTL1 & (0xfffful << (16))) >> (16)) * 2);
    ...
    uint32_t u32DLLLKNUM = ((((u32DllLockUs * (1000))) + (u32ClkNs) - 1) / (u32ClkNs));
    uint32_t u32DLLOVNUM = ((((u32DllValidUs * (1000))) + (u32ClkNs) - 1) / (u32ClkNs));
    uint32_t u32CLKONNUM = ((((u32DllClkOnUs * (1000))) + (u32ClkNs) - 1) / (u32ClkNs));
    uint32_t u32TRIMNUM = ((((u32DllTrimUs * (1000))) + (u32ClkNs) - 1) / (u32ClkNs));

    uint32_t u32Div = (((spim->CTL1 & (0xfffful << (16))) >> (16)) * 2);
    uint32_t u32FreqMHz = u32BusClkHz / 1000000;
    uint32_t u32FastEn = (u32FreqMHz <= 100) ? (0x00UL) : (0x01UL);
    ...
    (spim->DLL1 = ((spim->DLL1 & ~((0xfffful << (16)))) | ((u32DLLLKNUM) << (16))));
    (spim->DLL1 = ((spim->DLL1 & ~((0xfffful << (0)))) | ((u32DLLOVNUM) << (0))));
    (spim->DLL2 = ((spim->DLL2 & ~((0xfffful << (16)))) | ((u32CLKONNUM) << (16))));
    (spim->DLL2 = ((spim->DLL2 & ~((0xfffful << (0)))) | ((u32TRIMNUM) << (0))));


    do{ uint32_t u32Value = ((((*((volatile unsigned int *)(((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + 0xF84))))) & ~(0x1ul << (9))); (*((volatile unsigned int *)((((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + 0xF84)))=(u32Value)); }while(0);


    (spim->DLL0 = ((spim->DLL0 & ~((0x3ul << (20)))) | ((u32DllDivCode) << (20))));
    (spim->DLL0 = ((spim->DLL0 & ~((0x3ul << (22)))) | ((u32FastEn) << (22))));
    (spim->DLL0 = ((spim->DLL0 & ~((0x1ul << (0)))) | (((0x01UL)) << (0))));


    (spim->DLL0 = (spim->DLL0 & ~((0x1ul << (18)))) | (((0x01UL)) << (18)));
    (spim->DLL0 = ((spim->DLL0 & ~((0x1ul << (16)))) | (((0x01UL)) << (16))));



    (spim->DLL0 = ((spim->DLL0 & ~((0x1ul << (1)))) | (((0x01UL)) << (1))));


    i32TimeoutCount = (int32_t)SystemCoreClock;

    while (((spim->DLL0 & (0x1ul << (1))) >> (1)))
        if (--i32TimeoutCount <= 0) return (-2L);


    i32TimeoutCount = (int32_t)SystemCoreClock;

    while (((spim->DLL0 & (0x1ul << (2))) >> (2)) != (0x01UL))
        if (--i32TimeoutCount <= 0) return (-2L);


    i32TimeoutCount = (int32_t)SystemCoreClock;

    while (((spim->DLL0 & (0x1ul << (3))) >> (3)) != (0x01UL))
        if (--i32TimeoutCount <= 0) return (-2L);


    i32TimeoutCount = (int32_t)SystemCoreClock;

    while (((spim->DLL0 & (0x1ul << (4))) >> (4)) != (0x01UL))
        if (--i32TimeoutCount <= 0) return (-2L);
    ...
    while (((spim->DLL0 & (0x1ul << (6))) >> (6)) != (0x01UL))
        if (--i32TimeoutCount <= 0) return (-2L);

    u32DelayCycleCount = (uint32_t)(u32BusClkHz / 1000) * 3;

    for (i32TimeoutCount = 0; i32TimeoutCount < (int32_t)u32DelayCycleCount; i32TimeoutCount++)
        __nop();

    do{ uint32_t u32Value = ((((*((volatile unsigned int *)(((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + 0xF84))))) | (0x1ul << (9))); (*((volatile unsigned int *)((((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + 0xF84)))=(u32Value)); }while(0);
    (spim->DLL0 = (spim->DLL0 & ~((0x1ul << (18)))) | (((0x00UL)) << (18)));
...
# 641 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_SetDLLDelayNum(SPIM_T *spim, uint32_t u32DelayNum)
{
    volatile int i32TimeoutCount = (int32_t)SystemCoreClock;

    if (((spim->DLL0 & (0x1ul << (0))) >> (0)) != (0x01UL))
    {
        if (SPIM_HYPER_INIT_DLL(spim) != ( 0L))
        {
            return (-1L);
        }
    }
    ...
    while (((spim->DLL0 & (0x1ul << (5))) >> (5)) != (0x00UL))
        if (--i32TimeoutCount <= 0) return (-2L);


    (spim->DLL0 = ((spim->DLL0 & ~((0x1ful << (8)))) | ((u32DelayNum) << (8))));
