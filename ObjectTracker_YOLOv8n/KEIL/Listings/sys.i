...
# 124 "../../../../Library/StdDriver/src/sys.c"
void SYS_ResetModule(uint32_t u32ModuleIndex)
{
    uint32_t u32SPIM0CKEN;


    if (u32ModuleIndex == ((0x2B0UL<<20) | (0)))
    {

        u32SPIM0CKEN = ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPIMCTL & (0x1ul << (0));


        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPIMCTL &= ~(0x1ul << (0));
    }


    *(volatile uint32_t *)((uint32_t)((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + (u32ModuleIndex >> 20UL)) |= 1UL << (u32ModuleIndex & 0x000fffffUL);
    ...
    *(volatile uint32_t *)((uint32_t)((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + (u32ModuleIndex >> 20UL)) &= ~(1UL << (u32ModuleIndex & 0x000fffffUL));
    ...
    if (u32ModuleIndex == ((0x2B0UL<<20) | (0)))
    {
        ...
        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SPIMCTL |= u32SPIM0CKEN;
    }
}
# 171 "../../../../Library/StdDriver/src/sys.c"
int32_t SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{



    do{ uint32_t u32TimeOutCnt = SystemCoreClock; while(((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->BODCTL & (0x1ul << (31))) { if(--u32TimeOutCnt == 0) break; } }while(0);

    if ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->BODCTL & (0x1ul << (31))) == 0)
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->BODCTL = (((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->BODCTL & ~((0x1ul << (2)) | (0x7ul << (8)))) | ((uint32_t)i32Mode) | (u32BODLevel) | ((0x1ul << (0)));

    else return (-2L);

    return ( 0L);
}
# 194 "../../../../Library/StdDriver/src/sys.c"
int32_t SYS_DisableBOD(void)
{
    do{ uint32_t u32TimeOutCnt = SystemCoreClock; while(((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->BODCTL & (0x1ul << (31))) { if(--u32TimeOutCnt == 0) break; } }while(0);

    if ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->BODCTL & (0x1ul << (31))) == 0)
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->BODCTL &= ~(0x1ul << (0));
    else return (-2L);
