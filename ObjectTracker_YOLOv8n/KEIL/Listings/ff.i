# 1 "../../../../ThirdParty/FatFs/source/ff.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../ThirdParty/FatFs/source/ff.c" 2
# 22 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 23 "../../../../ThirdParty/FatFs/source/ff.c" 2
# 1 "../../../../ThirdParty/FatFs/source\\ff.h" 1
# 30 "../../../../ThirdParty/FatFs/source\\ff.h"
# 1 "..\\ffconf_M55M1.h" 1
...
# 53 "../../../../ThirdParty/FatFs/source\\ff.h" 2
typedef int INT;
...
# 24 "../../../../ThirdParty/FatFs/source/ff.c" 2
# 1 "../../../../ThirdParty/FatFs/source\\diskio.h" 1
# 15 "../../../../ThirdParty/FatFs/source\\diskio.h"
...
# 25 "../../../../ThirdParty/FatFs/source/ff.c" 2
# 464 "../../../../ThirdParty/FatFs/source/ff.c"
static FATFS *FatFs[9];
static WORD Fsid;


static BYTE CurrVol;
# 516 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 656 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 692 "../../../../ThirdParty/FatFs/source/ff.c"
...
)
{
 DWORD uc;
 const TCHAR *p = *str;
# 783 "../../../../ThirdParty/FatFs/source/ff.c"
 BYTE b;
 WCHAR wc;
...
{
# 873 "../../../../ThirdParty/FatFs/source/ff.c"
 WCHAR wc;

 wc = ff_uni2oem(chr, 932);
 if (wc >= 0x100) {
  if (szb < 2) return 0;
  *buf++ = (char)(wc >> 8);
  *buf++ = (TCHAR)wc;
...
# 1055 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 1108 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 1144 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 1161 "../../../../ThirdParty/FatFs/source/ff.c"
...
)
{
 ...
 if (clst < 2 || clst >= fs->n_fatent) {
  ...
  case 3 :
   ...
   break;
# 1223 "../../../../ThirdParty/FatFs/source/ff.c"
  default:
   val = 1;
  }
 }
...
# 1239 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 1429 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 1485 "../../../../ThirdParty/FatFs/source/ff.c"
  clst = nxt;
 } while (clst < fs->n_fatent);
# 1514 "../../../../ThirdParty/FatFs/source/ff.c"
 return FR_OK;
}
# 1524 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 1573 "../../../../ThirdParty/FatFs/source/ff.c"
 {
  ncl = 0;
  if (scl == clst) {
   ncl = scl + 1;
...
# 1658 "../../../../ThirdParty/FatFs/source/ff.c"
...
)
{
 ...
 fs->winsect = sect;
 memset(fs->win, 0, sizeof fs->win);
# 1682 "../../../../ThirdParty/FatFs/source/ff.c"
 {
  ibuf = fs->win; szb = 1;
...
# 1697 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 1745 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 1806 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 1848 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 1885 "../../../../ThirdParty/FatFs/source/ff.c"
static int cmp_lfn (
 const WCHAR* lfnbuf,
 BYTE* dir
)
...
# 1959 "../../../../ThirdParty/FatFs/source/ff.c"
static void put_lfn (
 const WCHAR* lfn,
 BYTE* dir,
 BYTE ord,
...
# 1996 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 2053 "../../../../ThirdParty/FatFs/source/ff.c"
static BYTE sum_sfn (
 const BYTE* dir
)
{
...
# 2306 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 2341 "../../../../ThirdParty/FatFs/source/ff.c"
  {
...
# 2384 "../../../../ThirdParty/FatFs/source/ff.c"
...
)
{
 ...
 res = dir_sdi(dp, 0);
 if (res != FR_OK) return res;
# 2419 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 2465 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 2511 "../../../../ThirdParty/FatFs/source/ff.c"
 memcpy(sn, dp->fn, 12);
 if (sn[11] & 0x01) {
  dp->fn[11] = 0x40;
  for (n = 1; n < 100; n++) {
...
# 2571 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 2605 "../../../../ThirdParty/FatFs/source/ff.c"
 return res;
}
# 2617 "../../../../ThirdParty/FatFs/source/ff.c"
...
)
{
 ...
 fno->fname[0] = 0;
 if (dp->sect == 0) return;
# 2671 "../../../../ThirdParty/FatFs/source/ff.c"
 {
...
# 2712 "../../../../ThirdParty/FatFs/source/ff.c"
 ...
 *path = p;
 ...
 for (;;) {
  ...
  if (wc >= 0x80) {
   cf |= 0x02;
# 2940 "../../../../ThirdParty/FatFs/source/ff.c"
   wc = ff_uni2oem(ff_wtoupper(wc), 932);
 ...
 return FR_OK;
# 3042 "../../../../ThirdParty/FatFs/source/ff.c"
}
# 3051 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 3087 "../../../../ThirdParty/FatFs/source/ff.c"
 if ((UINT)*path < ' ') {
  dp->fn[11] = 0x80;
  res = dir_sdi(dp, 0);
...
# 3122 "../../../../ThirdParty/FatFs/source/ff.c"
   {
...
# 3138 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 3176 "../../../../ThirdParty/FatFs/source/ff.c"
  if (i < 9) {
   vol = i;
   *path = tt;
  }
...
# 3203 "../../../../ThirdParty/FatFs/source/ff.c"
 vol = CurrVol;
...
# 3291 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 3367 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 3385 "../../../../ThirdParty/FatFs/source/ff.c"
 ...
 *rfs = fs;
 ...
 bsect = fs->winsect;
# 3511 "../../../../ThirdParty/FatFs/source/ff.c"
 {
...
# 3613 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 3633 "../../../../ThirdParty/FatFs/source/ff.c"
...
# 3657 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_mount (
 FATFS* fs,
 const TCHAR* path,
 BYTE opt
)
{
 ...
 if (fs) {
  fs->pdrv = (BYTE)(vol);
# 3700 "../../../../ThirdParty/FatFs/source/ff.c"
  fs->fs_type = 0;
  FatFs[vol] = fs;
 }
...
# 3717 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_open (
 FIL* fp,
 const TCHAR* path,
 BYTE mode
...
# 3792 "../../../../ThirdParty/FatFs/source/ff.c"
    {
...
# 3845 "../../../../ThirdParty/FatFs/source/ff.c"
  if (res == FR_OK) {
# 3854 "../../../../ThirdParty/FatFs/source/ff.c"
   {
...
# 3914 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_read (
 FIL* fp,
 void* buff,
 UINT btr,
...
# 4014 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_write (
 FIL* fp,
 const void* buff,
 UINT btw,
...
# 4135 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_sync (
 FIL* fp
)
{
 ...
 if (res == FR_OK) {
  if (fp->flag & 0x40) {
   ...
   tm = get_fattime();
# 4187 "../../../../ThirdParty/FatFs/source/ff.c"
   {
...
# 4216 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_close (
 FIL* fp
)
{
...
# 4252 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_chdrive (
 const TCHAR* path
)
{
 ...
 if (res == FR_OK) {
  ...
  if (res == FR_OK) {
   if (dj.fn[11] & 0x80) {
    ...
    if (dj.obj.attr & 0x10) {
# 4308 "../../../../ThirdParty/FatFs/source/ff.c"
     {
...
# 4433 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_lseek (
 FIL* fp,
 FSIZE_t ofs
)
{
 ...
 if (res != FR_OK) return res;
# 4511 "../../../../ThirdParty/FatFs/source/ff.c"
 {
...
# 4597 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_opendir (
 DIR* dp,
 const TCHAR* path
)
{
 ...
 if (res == FR_OK) {
  ...
  if (res == FR_OK) {
   if (!(dp->fn[11] & 0x80)) {
    if (dp->obj.attr & 0x10) {
# 4626 "../../../../ThirdParty/FatFs/source/ff.c"
     {
   ...
   if (res == FR_OK) {
    dp->obj.id = fs->id;
    res = dir_sdi(dp, 0);
# 4646 "../../../../ThirdParty/FatFs/source/ff.c"
   }
  }
               ;
  if (res == FR_NO_FILE) res = FR_NO_PATH;
...
# 4663 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_closedir (
 DIR *dp
)
{
...
# 4693 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_readdir (
 DIR* dp,
 FILINFO* fno
)
...
# 4781 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_stat (
 const TCHAR* path,
 FILINFO* fno
)
...
# 4816 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_getfree (
 const TCHAR* path,
 DWORD* nclst,
 FATFS** fatfs
...
# 4874 "../../../../ThirdParty/FatFs/source/ff.c"
    {
     clst = fs->n_fatent;
     sect = fs->fatbase;
     i = 0;
...
# 4912 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_truncate (
 FIL* fp
)
{
...
# 4962 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_unlink (
 const TCHAR* path
)
{
...
# 5056 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_mkdir (
 const TCHAR* path
)
{
 ...
 if (res == FR_OK) {
  ...
  if (res == FR_NO_FILE) {
   ...
   if (res == FR_OK) {
# 5114 "../../../../ThirdParty/FatFs/source/ff.c"
    {
     st_dword(dj.dir + 22, tm);
...
# 5140 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_rename (
...
)
{
 ...
 if (res == FR_OK) {
  ...
  if (res == FR_OK) {
# 5192 "../../../../ThirdParty/FatFs/source/ff.c"
   {
...
# 5250 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_chmod (
 const TCHAR* path,
 BYTE attr,
 BYTE mask
...
# 5297 "../../../../ThirdParty/FatFs/source/ff.c"
FRESULT f_utime (
 const TCHAR* path,
 const FILINFO* fno
)
