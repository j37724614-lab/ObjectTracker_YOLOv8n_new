# 1 "../../../../Library/StdDriver/src/i2s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/i2s.c" 2
# 10 "../../../../Library/StdDriver/src/i2s.c"
...
# 11 "../../../../Library/StdDriver/src/i2s.c" 2
...
# 12 "../../../../Library/StdDriver/src/i2s.c" 2
# 30 "../../../../Library/StdDriver/src/i2s.c"
uint32_t I2S_GetSourceClockFreq(I2S_T *i2s)
{
    uint32_t u32Freq = 0UL, u32ClkSrcSel;

    if (i2s == ((I2S_T *) ((((uint32_t) 0x40000000UL) + 0x00250000UL) + 0x0A000UL)))
    {

        u32ClkSrcSel = (CLK_GetModuleClockSource(((((22ULL) & 0xffUL) << 47)|((((uint64_t)(0)) & 0x1fUL) << 10)| (((9ULL) & 0xffUL) << 39)|(((0x7ULL) & 0xffUL) << 23)|((((uint64_t)(0)) & 0x1fUL) << 5)| (((7ULL) & 0xffUL) << 31)|(((0xFFULL) & 0xffUL) << 15)|((((uint64_t)(0)) & 0x1fUL) << 0))) << (0));
        ...
        u32Freq /= (CLK_GetModuleClockDivider(((((22ULL) & 0xffUL) << 47)|((((uint64_t)(0)) & 0x1fUL) << 10)| (((9ULL) & 0xffUL) << 39)|(((0x7ULL) & 0xffUL) << 23)|((((uint64_t)(0)) & 0x1fUL) << 5)| (((7ULL) & 0xffUL) << 31)|(((0xFFULL) & 0xffUL) << 15)|((((uint64_t)(0)) & 0x1fUL) << 0))) + 1UL);
    }
    else if (i2s == ((I2S_T *) ((((uint32_t) 0x40000000UL) + 0x00290000UL) + 0x08000UL)))
    {

        u32ClkSrcSel = (CLK_GetModuleClockSource(((((22ULL) & 0xffUL) << 47)|((((uint64_t)(1)) & 0x1fUL) << 10)| (((9ULL) & 0xffUL) << 39)|(((0x7ULL) & 0xffUL) << 23)|((((uint64_t)(4)) & 0x1fUL) << 5)| (((7ULL) & 0xffUL) << 31)|(((0xFFULL) & 0xffUL) << 15)|((((uint64_t)(8)) & 0x1fUL) << 0))) << (4));
        ...
        u32Freq /= (CLK_GetModuleClockDivider(((((22ULL) & 0xffUL) << 47)|((((uint64_t)(1)) & 0x1fUL) << 10)| (((9ULL) & 0xffUL) << 39)|(((0x7ULL) & 0xffUL) << 23)|((((uint64_t)(4)) & 0x1fUL) << 5)| (((7ULL) & 0xffUL) << 31)|(((0xFFULL) & 0xffUL) << 15)|((((uint64_t)(8)) & 0x1fUL) << 0))) + 1UL);
    }

    return u32Freq;
}
# 134 "../../../../Library/StdDriver/src/i2s.c"
uint32_t I2S_Open(I2S_T *i2s, uint32_t u32MasterSlave, uint32_t u32SampleRate, uint32_t u32WordWidth, uint32_t u32MonoData, uint32_t u32DataFormat)
{
    uint16_t u16Divider;
    ...
    if (i2s == ((I2S_T *) ((((uint32_t) 0x40000000UL) + 0x00250000UL) + 0x0A000UL)))
    {
        SYS_ResetModule(((0x258UL<<20) | (0)));
    }
    else if (i2s == ((I2S_T *) ((((uint32_t) 0x40000000UL) + 0x00290000UL) + 0x08000UL)))
    {
        SYS_ResetModule(((0x258UL<<20) | (1)));
    }
    ...
    i2s->CLKDIV = (i2s->CLKDIV & ~(0x1fful << (8))) | ((uint32_t)u16Divider << 8U);
...
# 196 "../../../../Library/StdDriver/src/i2s.c"
void I2S_EnableInt(I2S_T *i2s, uint32_t u32Mask)
{
    i2s->IEN |= u32Mask;
}
# 208 "../../../../Library/StdDriver/src/i2s.c"
void I2S_DisableInt(I2S_T *i2s, uint32_t u32Mask)
{
    i2s->IEN &= ~u32Mask;
}
...
uint32_t I2S_EnableMCLK(I2S_T *i2s, uint32_t u32BusClock)
{
    ...
    i2s->CLKDIV = (i2s->CLKDIV & ~(0x3ful << (0))) | u8Divider;

    i2s->CTL0 |= (0x1ul << (15));

    u32Reg = i2s->CLKDIV & (0x3ful << (0));
...
# 271 "../../../../Library/StdDriver/src/i2s.c"
void I2S_SetFIFO(I2S_T *i2s, uint32_t u32TxThreshold, uint32_t u32RxThreshold)
{
    i2s->CTL1 = (i2s->CTL1 & ~((0xful << (8)) | (0xful << (16)))) |
                (u32TxThreshold << (8)) |
                (u32RxThreshold << (16));
}
# 297 "../../../../Library/StdDriver/src/i2s.c"
void I2S_ConfigureTDM(I2S_T *i2s, uint32_t u32ChannelWidth, uint32_t u32ChannelNum, uint32_t u32SyncWidth)
{
    i2s->CTL0 = (i2s->CTL0 & ~((0x3ul << (30)) | (0x3ul << (28)) | (0x1ul << (27)))) |
                (u32ChannelWidth << (28)) |
                (u32ChannelNum << (30)) |
                (u32SyncWidth << (27));
}
