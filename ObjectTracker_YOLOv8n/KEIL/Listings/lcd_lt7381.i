# 1 "../Device/Display/LCD/LCD_LT7381.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Device/Display/LCD/LCD_LT7381.c" 2
...
# 9 "../Device/Display/LCD/LCD_LT7381.c" 2
...
# 10 "../Device/Display/LCD/LCD_LT7381.c" 2
...
# 11 "../Device/Display/LCD/LCD_LT7381.c" 2
# 26 "../Device/Display/LCD/LCD_LT7381.c"
# 1 "../Device/Display/LCD\\../drv_pdma.h" 1
# 35 "../Device/Display/LCD\\../drv_pdma.h"
typedef enum
{
...
# 27 "../Device/Display/LCD/LCD_LT7381.c" 2
# 70 "../Device/Display/LCD/LCD_LT7381.c"
typedef enum
{
    XI_4M,
    XI_5M,
...
typedef struct
{
    ...
    __attribute__((section(".bss.vram.data"), aligned(32))) uint16_t s_au16PDMALineBuf[800];



static const lt7381_pll_t s_PllSettings[XI_CNT] =
{
    {3, 3, 3, 2, 2, 2, (2 * 100), (2 * 100), (2 * ((((140 + 160 + 20 + 800) * (20 + 12 + 3 + 480) * 60)/1000000)+1)) },
    {3, 3, 3, 5, 5, 5, (4 * 100), (4 * 100), (4 * ((((140 + 160 + 20 + 800) * (20 + 12 + 3 + 480) * 60)/1000000)+1)) },
    {3, 3, 3, 2, 2, 2, (1 * 100), (1 * 100), (1 * ((((140 + 160 + 20 + 800) * (20 + 12 + 3 + 480) * 60)/1000000)+1)) },
    {3, 3, 3, 5, 5, 5, (2 * 100), (2 * 100), (2 * ((((140 + 160 + 20 + 800) * (20 + 12 + 3 + 480) * 60)/1000000)+1)) },
    {3, 3, 3, 3, 3, 3, (1 * 100), (1 * 100), (1 * ((((140 + 160 + 20 + 800) * (20 + 12 + 3 + 480) * 60)/1000000)+1)) }
};
...
static void lt7381_hw_reset(void)
{
    ...
    (*((volatile uint32_t *)((((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29800UL)+(0x40*(7))) + ((6)<<2)))) = 1;
    Display_Delay(50);
    (*((volatile uint32_t *)((((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29800UL)+(0x40*(7))) + ((6)<<2)))) = 0;
    Display_Delay(50);
    (*((volatile uint32_t *)((((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29800UL)+(0x40*(7))) + ((6)<<2)))) = 1;
    Display_Delay(50);
}
...
static void lt7381_wait_ready(void)
{
    ...
    while (1)
    {
        if ((*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) & (0x00000002UL)) == 0x00)
        {
            Display_Delay(2);
            (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x01));
            u16RegData = *((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2)));

            if ((u16RegData & (0x00000080UL)) == (0x00000080UL))
            {
                break;
            }
            else
            {
                Display_Delay(2);
                (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x01));
                (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = ((0x00000080UL)));
            }
        }
    ...
    while (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) & (0x00000002UL));
}

static void lt7381_sw_reset(void)
{
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x00));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (0x01));
    Display_Delay(100);
}

static void lt7381_initial_pll(void)
{
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x05));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = ((s_PllSettings[XI_12M].lpllOD_sclk << 6) | (s_PllSettings[XI_12M].lpllR_sclk << 1) | (s_PllSettings[XI_12M].lpllN_sclk >> 8) & 0x1));



    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x07));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = ((s_PllSettings[XI_12M].lpllOD_mclk << 6) | (s_PllSettings[XI_12M].lpllR_mclk << 1) | (s_PllSettings[XI_12M].lpllN_mclk >> 8) & 0x1));



    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x09));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = ((s_PllSettings[XI_12M].lpllOD_cclk << 6) | (s_PllSettings[XI_12M].lpllR_cclk << 1) | (s_PllSettings[XI_12M].lpllN_cclk >> 8) & 0x1));



    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x06));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (s_PllSettings[XI_12M].lpllN_sclk));

    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x08));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (s_PllSettings[XI_12M].lpllN_mclk));

    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x0a));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (s_PllSettings[XI_12M].lpllN_cclk));

    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x00));
    Display_Delay(1);
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (0x80));
    Display_Delay(1);
}
...
void lt7381_write_reg(uint16_t reg, uint16_t data)
{
    ...
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (reg & 0xFF));


    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (data & 0xFF));
}

static void lt7381_initial_sdram(void)
{
    lt7381_write_reg(0xe0, 0x20);
    lt7381_write_reg(0xe1, 0x03);

    lt7381_write_reg(0xe2, ((64000000 / 8192) / (1000 / 100) - 2));
    lt7381_write_reg(0xe3, ((64000000 / 8192) / (1000 / 100) - 2) >> 8);
    lt7381_write_reg(0xe4, 0x01);



    while ((*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) & (0x00000004UL)) == 0x00);
...
static void lt7381_initial_panel(void)
{
    ...
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x01));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = ((*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~(0x00000008UL)) | (0x00000010UL)));
    ...
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x01));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) | (0x00000001UL)));



    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x02));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = ((*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~(0x00000080UL)) | (0x00000040UL)));


    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x02));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~((0x00000004UL) | (0x00000002UL))));



    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x03));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~(0x00000004UL)));


    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x03));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~((0x00000002UL) | (0x00000001UL))));
    ...
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x12));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) | (0x00000080UL)));
    ...
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x12));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~(0x00000008UL)));
# 285 "../Device/Display/LCD/LCD_LT7381.c"
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x12));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~((0x00000001UL) | (0x00000002UL) | (0x00000004UL))));
    ...
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x13));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~((0x00000080UL))));
    ...
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x13));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~((0x00000040UL))));
    ...
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x13));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~((0x00000020UL))));
# 326 "../Device/Display/LCD/LCD_LT7381.c"
    lt7381_write_reg(0x14, (800 < 8) ? 0 : ((800 / 8) - 1));
    lt7381_write_reg(0x15, (800 < 8) ? 800 : 800 % 8);
    lt7381_write_reg(0x1A, (480 - 1));
    lt7381_write_reg(0x1B, (480 - 1) >> 8);
# 351 "../Device/Display/LCD/LCD_LT7381.c"
    lt7381_write_reg(0x16, (140 < 8) ? 0 : (140 / 8) - 1);
    lt7381_write_reg(0x17, (140 < 8) ? 140 : (140 % 8));

    lt7381_write_reg(0x18, (160 < 8) ? 0 : ((160 / 8) - 1));
    lt7381_write_reg(0x19, (20 < 8) ? 0 : ((20 / 8) - 1));
# 370 "../Device/Display/LCD/LCD_LT7381.c"
    lt7381_write_reg(0x1C, (20 - 1));
    lt7381_write_reg(0x1D, (20 - 1) >> 8);

    lt7381_write_reg(0x1E, 12 - 1);
    lt7381_write_reg(0x1F, 3 - 1);
    ...
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x5E));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~((0x00000004UL))));
# 396 "../Device/Display/LCD/LCD_LT7381.c"
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x5E));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = ((*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~((0x00000002UL))) | (0x00000001UL)));
}
...
static void lt7381_display_on(void)
{
    ...
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x12));
    temp = *((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2)));
    temp |= (0x00000040UL);
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (temp));
}
...
static void lt7381_initial_main_window(void)
{
    ...
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x10));
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = ((*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) & ~((0x00000008UL))) | (0x00000004UL)));
# 434 "../Device/Display/LCD/LCD_LT7381.c"
    lt7381_write_reg(0x20, 0x0);
    lt7381_write_reg(0x21, 0x0 >> 8);
    lt7381_write_reg(0x22, 0x0 >> 16);
    lt7381_write_reg(0x23, 0x0 >> 24);
# 447 "../Device/Display/LCD/LCD_LT7381.c"
    lt7381_write_reg(0x24, 800);
    lt7381_write_reg(0x25, 800 >> 8);
# 465 "../Device/Display/LCD/LCD_LT7381.c"
    lt7381_write_reg(0x26, 0x0);
    lt7381_write_reg(0x27, 0x0 >> 8);
    lt7381_write_reg(0x28, 0x0);
    lt7381_write_reg(0x29, 0x0 >> 8);
# 479 "../Device/Display/LCD/LCD_LT7381.c"
    lt7381_write_reg(0x50, 0x0);
    lt7381_write_reg(0x51, 0x0 >> 8);
    lt7381_write_reg(0x52, 0x0 >> 16);
    lt7381_write_reg(0x53, 0x0 >> 24);
    lt7381_write_reg(0x54, 800);
    lt7381_write_reg(0x55, 800 >> 8);
# 497 "../Device/Display/LCD/LCD_LT7381.c"
    lt7381_write_reg(0x56, 0x0);
    lt7381_write_reg(0x57, 0x0 >> 8);
    lt7381_write_reg(0x58, 0x0);
    lt7381_write_reg(0x59, 0x0 >> 8);
    lt7381_write_reg(0x5A, 800);
    lt7381_write_reg(0x5B, 800 >> 8);
    lt7381_write_reg(0x5C, 480);
    lt7381_write_reg(0x5D, 480 >> 8);
...
{
    (*((volatile uint32_t *)((((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29800UL)+(0x40*(7))) + ((6)<<2)))) = 1;
    (*((volatile uint32_t *)((((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29800UL)+(0x40*(6))) + ((5)<<2)))) = 0;
    ...
    (*((volatile uint32_t *)((((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29800UL)+(0x40*(6))) + ((5)<<2)))) = 1;
...
{
    return (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) & (0x00000080UL));
}
# 579 "../Device/Display/LCD/LCD_LT7381.c"
static void lt7381_send_pixels(uint16_t *pixels, uint32_t destWidth, uint32_t destHeight, uint32_t fixedColor, int32_t byteLen, int32_t scaleUpFactory)
{
    ...
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x04));
    ...
    if ((pixels) && (byteLen > 1024))
    {
        ...
        if (scaleUpFactory == 1)
        {
            ...
            nu_pdma_mempush((void *)((0x60000000UL +(0UL*0x00100000UL)) + (0x2)), (void *)pixels, 16, count);
        }
        else
        {
            ...
            for (h = 0; h < destHeight; h += scaleUpFactory)
            {
                ...
                {
                    nu_pdma_mempush((void *)((0x60000000UL +(0UL*0x00100000UL)) + (0x2)), (void *)s_au16PDMALineBuf, 16, destWidth);
                }
            ...
            for (r_y = 0; r_y < scaleUpFactory; r_y++)
            {
                ...
                for (w = 0; w < destWidth; w += scaleUpFactory)
                {
                    ...
                    for (r_x = 0; r_x < scaleUpFactory; r_x++)
                    {
                        ...
                        (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (color));
                    }
                }
            }
        ...
        for (r_y = 0; r_y < scaleUpFactory; r_y++)
        {
            ...
            for (j = 0; j < 8; j++)
            {
                for (r_x = 0; r_x < scaleUpFactory; r_x++)
                {
                    if ((m & 0x80) == 0x80)
                    {
                        (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (fColor));
                    }
                    else
                    {
                        (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x2))) = (bColor));
                    }
                }
