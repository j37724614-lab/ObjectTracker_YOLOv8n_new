# 1 "../../../../Library/StdDriver/src/hsusbd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/hsusbd.c" 2
# 10 "../../../../Library/StdDriver/src/hsusbd.c"
...
# 11 "../../../../Library/StdDriver/src/hsusbd.c" 2
...
# 12 "../../../../Library/StdDriver/src/hsusbd.c" 2
# 28 "../../../../Library/StdDriver/src/hsusbd.c"
S_HSUSBD_CMD_T gUsbCmd;
S_HSUSBD_INFO_T *g_hsusbd_sInfo;

HSUSBD_VENDOR_REQ g_hsusbd_pfnVendorRequest = 0;
HSUSBD_CLASS_REQ g_hsusbd_pfnClassRequest = 0;
HSUSBD_SET_INTERFACE_REQ g_hsusbd_pfnSetInterface = 0;
uint32_t g_u32HsEpStallLock = 0ul;
...
# 68 "../../../../Library/StdDriver/src/hsusbd.c"
int32_t HSUSBD_Open(S_HSUSBD_INFO_T *param, HSUSBD_CLASS_REQ pfnClassReq, HSUSBD_SET_INTERFACE_REQ pfnSetInterface)
{
    uint32_t u32TimeOutCnt;
    ...
    ((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->OPER &= ~(0x1ul << (1));

    return ( 0L);
}
# 104 "../../../../Library/StdDriver/src/hsusbd.c"
void HSUSBD_Start(void)
{
    ((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->OPER = (0x1ul << (1));
...
# 120 "../../../../Library/StdDriver/src/hsusbd.c"
void HSUSBD_ProcessSetupPacket(void)
{

    gUsbCmd.bmRequestType = (uint8_t)(((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->SETUP1_0 & 0xfful);
    gUsbCmd.bRequest = (uint8_t)((((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->SETUP1_0 >> 8) & 0xfful);
    gUsbCmd.wValue = (uint16_t)((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->SETUP3_2;
    gUsbCmd.wIndex = (uint16_t)((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->SETUP5_4;
    gUsbCmd.wLength = (uint16_t)((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->SETUP7_6;
    ...
    switch (gUsbCmd.bmRequestType & 0x60ul)
    {
        ...
        case 0x40ul:
        {
            if (g_hsusbd_pfnVendorRequest != 0)
            {
...
# 176 "../../../../Library/StdDriver/src/hsusbd.c"
int HSUSBD_GetDescriptor(void)
{
    ...
    switch ((gUsbCmd.wValue & 0xff00ul) >> 8)
    {
        ...
        case 0x02ul:
        {
            ...
            if ((((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->OPER & 0x04ul) == 0x04ul)
            {
...
# 258 "../../../../Library/StdDriver/src/hsusbd.c"
        case 0x06ul:
        {
            u32Len = (((u32Len)<(10ul)) ? (u32Len) : (10ul));
...
# 381 "../../../../Library/StdDriver/src/hsusbd.c"
void HSUSBD_StandardRequest(void)
{
    ...
    if ((gUsbCmd.bmRequestType & 0x80ul) == 0x80ul)
    {
        ...
        switch (gUsbCmd.bRequest)
        {
            ...
            case 0x00ul:
            {
                ...
                if (gUsbCmd.bmRequestType == 0x80ul)
                {
                    ...
                    {
                        u8Tmp |= (uint8_t)(g_hsusbd_RemoteWakeupEn << 1ul);
                    }
    ...
    else
    {
        ...
        switch (gUsbCmd.bRequest)
        {
            case 0x01ul:
            {
                if ((gUsbCmd.wValue & 0xfful) == 0x00ul)
                {
                    ...
                    for (i = 0ul; i < 18ul; i++)
                    {
                        if ((((((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->EP[i].EPCFG & 0xf0ul) >> 4) == epNum) && ((g_u32HsEpStallLock & (1ul << i)) == 0ul))
                        {
                            ((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->EP[i].EPRSPCTL = (((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->EP[i].EPRSPCTL & 0xeful) | ((uint32_t)0x00000008ul);
                        }
                    }
                }
                else if ((gUsbCmd.wValue & 0xfful) == 0x01ul)
                {
            ...
            case 0x03ul:
            {
                if ((gUsbCmd.wValue & 0x3ul) == 2ul)
                {
                    g_hsusbd_EnableTestMode = (uint8_t)1ul;
                    g_hsusbd_TestSelector = (uint8_t)(gUsbCmd.wIndex >> 8);
                }

                if ((gUsbCmd.wValue & 0x3ul) == 3ul)
                {
                    ((HSOTG_T *) ((((uint32_t) 0x40000000UL) + 0x00250000UL) + 0x09000UL))->CTL |= ((0x1ul << (2)) | (0x1ul << (1)));
                }

                if ((gUsbCmd.wValue & 0x01ul) == 0x01ul)
                {
...
# 596 "../../../../Library/StdDriver/src/hsusbd.c"
void HSUSBD_UpdateDeviceState(void)
{
    switch (gUsbCmd.bRequest)
    {
        case 0x05ul:
        {
            (((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->FADDR = (g_hsusbd_UsbAddr));
            break;
        }
        ...
        case 0x09ul:
        {
            if (g_hsusbd_UsbConfig == 0ul)
            {
                ...
                for (i = 0ul; i < 18ul; i++)
                {
                    if ((((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->EP[i].EPCFG & 0x1ul) == 0x1ul)
                    {
                        ((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->EP[i].EPRSPCTL = ((uint32_t)0x00000008ul);
                    }
                }
        ...
        case 0x03ul:
        {
            ...
            else if (g_hsusbd_EnableTestMode)
            {
                ...
                if (g_hsusbd_TestSelector == 0x01ul)
                {
                    ((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->TEST = 0x01ul;
                }
                else if (g_hsusbd_TestSelector == 0x02ul)
                {
                    ((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->TEST = 0x02ul;
                }
                else if (g_hsusbd_TestSelector == 0x03ul)
                {
                    ((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->TEST = 0x03ul;
                }
                else if (g_hsusbd_TestSelector == 0x04ul)
                {
                    ((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->TEST = 0x04ul;
                }
                else if (g_hsusbd_TestSelector == 0x05ul)
                {
                    ((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->TEST = 0x05ul;
                }
            }
...
# 699 "../../../../Library/StdDriver/src/hsusbd.c"
void HSUSBD_PrepareCtrlIn(uint8_t pu8Buf[], uint32_t u32Size)
{
    g_hsusbd_CtrlInPointer = pu8Buf;
    g_hsusbd_CtrlInSize = u32Size;
}
# 716 "../../../../Library/StdDriver/src/hsusbd.c"
void HSUSBD_CtrlIn(void)
{
    uint32_t i, cnt;
    uint8_t u8Value;
    ...
    if (g_hsusbd_CtrlInSize >= g_hsusbd_CtrlMaxPktSize)
    {
        ...
        for (i = 0ul; i < cnt; i++)
        {
            ((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->CEPDAT = *(uint32_t *)g_hsusbd_CtrlInPointer;
            g_hsusbd_CtrlInPointer = (uint8_t *)(g_hsusbd_CtrlInPointer + 4ul);
        }

        (((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->CEPTXCNT = (g_hsusbd_CtrlMaxPktSize));
    ...
    else
    {
        ...
        for (i = 0ul; i < cnt; i++)
        {
            ...
            (*((volatile unsigned char *)(&((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->CEPDAT))=(u8Value));
        }

        (((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->CEPTXCNT = (g_hsusbd_CtrlInSize));
        g_hsusbd_CtrlInPointer = 0;
        g_hsusbd_CtrlInSize = 0ul;
    }
}
# 763 "../../../../Library/StdDriver/src/hsusbd.c"
int32_t HSUSBD_CtrlOut(uint8_t pu8Buf[], uint32_t u32Size)
{
    uint32_t i;
    uint32_t u32TimeOutCnt = SystemCoreClock;
    ...
    while (1)
    {
        if ((((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->CEPINTSTS & (0x1ul << (6))) == (0x1ul << (6)))
        {
            for (i = 0ul; i < u32Size; i++)
            {
                pu8Buf[i] = ((*((volatile unsigned char *)(&((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->CEPDAT))));
            }
...
# 796 "../../../../Library/StdDriver/src/hsusbd.c"
void HSUSBD_SwReset(void)
{
    ...
    (((HSUSBD_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x05000UL))->FADDR = (0ul));
}
# 817 "../../../../Library/StdDriver/src/hsusbd.c"
void HSUSBD_SetVendorRequest(HSUSBD_VENDOR_REQ pfnVendorReq)
{
