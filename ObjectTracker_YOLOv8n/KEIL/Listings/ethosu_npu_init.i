# 1 "../NPU/ethosu_npu_init.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../NPU/ethosu_npu_init.c" 2
# 18 "../NPU/ethosu_npu_init.c"
# 1 "../NPU/include\\ethosu_npu_init.h" 1
# 26 "../NPU/include\\ethosu_npu_init.h"
...
# 21 "../NPU/ethosu_npu_init.c" 2

# 1 "../NPU/include\\ethosu_mem_config.h" 1
# 23 "../NPU/ethosu_npu_init.c" 2
...
{
    const IRQn_Type ethosu_irqnum = (IRQn_Type)NPU_IRQn;


    __NVIC_EnableIRQ(ethosu_irqnum);
...
int arm_ethosu_npu_init(void)
{
    ...
    const void *ethosu_base_address = (void *)(((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x03000UL));
    ...
    if (0 != (err = ethosu_init(
                        ...
                        1)))
    {
        printf("ERROR - "); printf("failed to initialise Ethos-U device\n");
        return err;
    }

    printf("INFO - "); printf("Ethos-U device initialised\n");
    ...
    printf("INFO - "); printf("Ethos-U version info:\n");
    printf("INFO - "); printf("\tArch:       v%" "u" ".%" "u" ".%" "u" "\n", hw_info.version.arch_major_rev, hw_info.version.arch_minor_rev, hw_info.version.arch_patch_rev);



    printf("INFO - "); printf("\tDriver:     v%" "d" ".%" "d" ".%" "d" "\n", driver_version.major, driver_version.minor, driver_version.patch);



    printf("INFO - "); printf("\tMACs/cc:    %" "u" "\n", (uint32_t)(1 << hw_info.cfg.macs_per_cc));
    printf("INFO - "); printf("\tCmd stream: v%" "u" "\n", hw_info.cfg.cmd_stream_version);
