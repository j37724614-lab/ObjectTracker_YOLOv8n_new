...
void EBI_Open(uint32_t u32Bank, uint32_t u32DataWidth, uint32_t u32TimingClass, uint32_t u32BusMode, uint32_t u32CSActiveLevel)
{
    uint32_t u32Index0 = (uint32_t)&((EBI_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x30000UL))->CTL0 + ((uint32_t)u32Bank * 0x10UL);
    uint32_t u32Index1 = (uint32_t)&((EBI_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x30000UL))->TCTL0 + ((uint32_t)u32Bank * 0x10UL);
...
void EBI_Close(uint32_t u32Bank)
{
    uint32_t u32Index = (uint32_t)&((EBI_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x30000UL))->CTL0 + (u32Bank * 0x10UL);
...
void EBI_SetBusTiming(uint32_t u32Bank, uint32_t u32TimingConfig, uint32_t u32MclkDiv)
{
    uint32_t u32Index0 = (uint32_t)&((EBI_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x30000UL))->CTL0 + (u32Bank * 0x10UL);
    uint32_t u32Index1 = (uint32_t)&((EBI_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x30000UL))->TCTL0 + (u32Bank * 0x10UL);
    volatile uint32_t *pu32EBICTL = (uint32_t *)(u32Index0);
    volatile uint32_t *pu32EBITCTL = (uint32_t *)(u32Index1);
