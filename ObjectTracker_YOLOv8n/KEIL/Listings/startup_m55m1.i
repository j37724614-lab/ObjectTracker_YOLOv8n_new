# 1 "../../../../Library/Device/Nuvoton/M55M1/Source/startup_M55M1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/Device/Nuvoton/M55M1/Source/startup_M55M1.c" 2
# 10 "../../../../Library/Device/Nuvoton/M55M1/Source/startup_M55M1.c"
...
# 213 "C:\\Users\\antia\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\inttypes.h" 3
...
# 11 "../../../../Library/Device/Nuvoton/M55M1/Source/startup_M55M1.c" 2
...
# 12 "../../../../Library/Device/Nuvoton/M55M1/Source/startup_M55M1.c" 2
...
# 13 "../../../../Library/Device/Nuvoton/M55M1/Source/startup_M55M1.c" 2
...
extern __attribute__((__noreturn__)) void __main(void);
...
# 204 "../../../../Library/Device/Nuvoton/M55M1/Source/startup_M55M1.c"
const VECTOR_TABLE_Type __Vectors[] __attribute__((used, section("RESET"))) =
# 228 "../../../../Library/Device/Nuvoton/M55M1/Source/startup_M55M1.c"
{
    (VECTOR_TABLE_Type)(&Image$$ARM_LIB_STACK$$ZI$$Limit),
    Reset_Handler,
    NMI_Handler,
    HardFault_Handler,
    MemManage_Handler,
...
__attribute__((weak)) void Reset_Handler_PreInit(void)
{
    ...
    CLK_SetBusClock((0x4UL << (0)), 0x00000002UL, (220000000UL));
...
__attribute__((__noreturn__)) void Reset_Handler(void)
{
    ...
    __asm volatile("MSR psp, %0" : : "r"((uint32_t)(&Image$$ARM_LIB_STACK$$ZI$$Limit)) :);
    __asm volatile("MSR msplim, %0" : : "r"((uint32_t)(&Image$$ARM_LIB_STACK$$ZI$$Base)));
    __asm volatile("MSR psplim, %0" : : "r"((uint32_t)(&Image$$ARM_LIB_STACK$$ZI$$Base)));


    if (((((SCU_T *) (((((uint32_t) 0x40000000UL) + 0x00400000UL) + 0x02000UL) + ((uint32_t) 0x10000000UL)))->NSMSTS & (0x1ul << (0))) >> (0)) == 0)
    {
        int32_t i32TimeOutCnt = (12000000UL);
        ...
        if (((PMC_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x02000UL))->SYSRB1PC != 0)
        {
            ((PMC_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x02000UL))->SYSRB1PC = 0;
        }


        if (((PMC_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x02000UL))->SYSRB2PC != 0)
        {
            ((PMC_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x02000UL))->SYSRB2PC = 0;
        }


        while (1)
        {
            if ((((PMC_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x02000UL))->SYSRB1PC & (0x1ul << (31))) == 0 &&
                    (((PMC_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x02000UL))->SYSRB2PC & (0x1ul << (31))) == 0)
                break;
        ...
        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SRAMCTL |= ((0x1ul << (1)) | (0x1ul << (2)));
    }
    ...
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->CPACR |= ((3U << 10U * 2U) |
                   (3U << 11U * 2U));
# 518 "../../../../Library/Device/Nuvoton/M55M1/Source/startup_M55M1.c"
    ((PwrModCtl_Type *) (0xE001E300UL) )->CPDLPSTATE &= ~((0x3UL << 4U) << 4U);



    ((PwrModCtl_Type *) (0xE001E300UL) )->CPDLPSTATE |= 0x1 << 4U;
...
{
    uint32_t u32IRQ = 0;
    struct StackFrame *psStackFrame = 0;
