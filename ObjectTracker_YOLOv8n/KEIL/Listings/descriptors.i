# 1 "../Device/UVC/descriptors.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Device/UVC/descriptors.c" 2
# 10 "../Device/UVC/descriptors.c"
...
# 12 "../Device/UVC/descriptors.c" 2



uint8_t gu8DeviceDescriptor[] __attribute__((aligned((32U)))) =
{
    18ul,
    0x01ul,
    0x00, 0x02,
...
uint8_t gu8QualifierDescriptor[] __attribute__((aligned((32U)))) =
{
    10ul,
    0x06ul,
    0x00, 0x02,
...
uint8_t gu8ConfigDescriptor[] __attribute__((aligned((32U)))) =
{
    9ul,
    0x02ul,
    0x58, 0x01,
...
uint8_t gu8OtherConfigDescriptorHS[] __attribute__((aligned((32U)))) =
{
    9ul,
    0x07ul,
    0x58, 0x01,
...
uint8_t gu8ConfigDescriptorFS[] __attribute__((aligned((32U)))) =
{
    9ul,
    0x02ul,
    0x58, 0x01,
...
uint8_t gu8OtherConfigDescriptorFS[] __attribute__((aligned((32U)))) =
{
    9ul,
    0x07ul,
    0x58, 0x01,
...
uint8_t gu8StringLang[4] __attribute__((aligned((32U)))) =
{
    4,
    0x03ul,
    0x09, 0x04
...
uint8_t gu8VendorStringDesc[] __attribute__((aligned((32U)))) =
{
    16,
    0x03ul,
...
uint8_t gu8ProductStringDesc[] __attribute__((aligned((32U)))) =
{
    22,
    0x03ul,
