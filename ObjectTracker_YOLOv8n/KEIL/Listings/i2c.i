...
# 10 "../../../../Library/StdDriver/src/i2c.c"
...
# 11 "../../../../Library/StdDriver/src/i2c.c" 2
# 20 "../../../../Library/StdDriver/src/i2c.c"
int32_t g_I2C_i32ErrCode = 0;
# 39 "../../../../Library/StdDriver/src/i2c.c"
uint32_t I2C_Open(I2C_T *i2c, uint32_t u32BusClock)
{
    uint32_t u32Div;
    uint32_t u32Pclk;

    if ((i2c == ((I2C_T *) ((((uint32_t) 0x40000000UL) + 0x00280000UL) + 0x08000UL))) || (i2c == ((I2C_T *) ((((uint32_t) 0x40000000UL) + 0x00280000UL) + 0x09000UL))))
    {
...
void I2C_Close(I2C_T *i2c)
{
    ...
    if (i2c == ((I2C_T *) ((((uint32_t) 0x40000000UL) + 0x00240000UL) + 0x08000UL)))
    {
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->I2CRST |= (0x1ul << (0));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->I2CRST &= ~(0x1ul << (0));
    }
    else if (i2c == ((I2C_T *) ((((uint32_t) 0x40000000UL) + 0x00280000UL) + 0x08000UL)))
    {
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->I2CRST |= (0x1ul << (1));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->I2CRST &= ~(0x1ul << (1));
    }
    else if (i2c == ((I2C_T *) ((((uint32_t) 0x40000000UL) + 0x00240000UL) + 0x09000UL)))
    {
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->I2CRST |= (0x1ul << (2));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->I2CRST &= ~(0x1ul << (2));
    }
    else if (i2c == ((I2C_T *) ((((uint32_t) 0x40000000UL) + 0x00280000UL) + 0x09000UL)))
    {
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->I2CRST |= (0x1ul << (3));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->I2CRST &= ~(0x1ul << (3));
    }
...
# 120 "../../../../Library/StdDriver/src/i2c.c"
void I2C_ClearTimeoutFlag(I2C_T *i2c)
{
    i2c->TOCTL |= (0x1ul << (0));
}
# 137 "../../../../Library/StdDriver/src/i2c.c"
void I2C_Trigger(I2C_T *i2c, uint8_t u8Start, uint8_t u8Stop, uint8_t u8Si, uint8_t u8Ack)
{
    uint32_t u32Reg = 0U;
...
# 172 "../../../../Library/StdDriver/src/i2c.c"
void I2C_DisableInt(I2C_T *i2c)
{
    i2c->CTL0 &= ~(0x1ul << (7));
}
...
# 199 "../../../../Library/StdDriver/src/i2c.c"
uint32_t I2C_GetBusClockFreq(I2C_T *i2c)
{
...
# 226 "../../../../Library/StdDriver/src/i2c.c"
uint32_t I2C_SetBusClockFreq(I2C_T *i2c, uint32_t u32BusClock)
{
    uint32_t u32Div;
    uint32_t u32Pclk;
...
# 280 "../../../../Library/StdDriver/src/i2c.c"
uint32_t I2C_GetStatus(I2C_T *i2c)
{
    return (i2c->STATUS0);
}
# 294 "../../../../Library/StdDriver/src/i2c.c"
uint8_t I2C_GetData(I2C_T *i2c)
{
    return (uint8_t)(i2c->DAT);
}
# 307 "../../../../Library/StdDriver/src/i2c.c"
void I2C_SetData(I2C_T *i2c, uint8_t u8Data)
{
    i2c->DAT = u8Data;
}
# 324 "../../../../Library/StdDriver/src/i2c.c"
void I2C_SetSlaveAddr(I2C_T *i2c, uint8_t u8SlaveNo, uint16_t u16SlaveAddr, uint8_t u8GCMode)
{
...
# 359 "../../../../Library/StdDriver/src/i2c.c"
void I2C_SetSlaveAddrMask(I2C_T *i2c, uint8_t u8SlaveNo, uint16_t u16SlaveAddrMask)
{
...
# 394 "../../../../Library/StdDriver/src/i2c.c"
void I2C_EnableTimeout(I2C_T *i2c, uint8_t u8LongTimeout)
{
    if (u8LongTimeout)
    {
...
# 429 "../../../../Library/StdDriver/src/i2c.c"
void I2C_EnableWakeup(I2C_T *i2c)
{
    i2c->WKCTL |= (0x1ul << (0));
}
...
# 461 "../../../../Library/StdDriver/src/i2c.c"
void I2C_EnableTwoBufferMode(I2C_T *i2c, uint32_t u32BitCount)
{

    i2c->CTL0 = (i2c->CTL0 & ~0x3C);
    i2c->STATUS1 &= ~((0x1ul << (20)) | (0x1ul << (21)));


    i2c->CTL1 |= ((0x1ul << (20)) | (0x1ul << (21)) | u32BitCount);


    i2c->CTL1 |= (0x1ul << (5));
}
# 484 "../../../../Library/StdDriver/src/i2c.c"
void I2C_DisableTwoBufferMode(I2C_T *i2c)
{

    i2c->CTL1 &= ~((0x1ul << (21)) | (0x1ul << (20)) | (0x3ul << (16)));


    i2c->CTL1 &= ~(0x1ul << (5));
}
# 503 "../../../../Library/StdDriver/src/i2c.c"
uint32_t I2C_SMBusGetStatus(I2C_T *i2c)
{
    return (i2c->BUSSTS);
}
# 517 "../../../../Library/StdDriver/src/i2c.c"
void I2C_SMBusClearInterruptFlag(I2C_T *i2c, uint8_t u8SMBusIntFlag)
{
    i2c->BUSSTS = u8SMBusIntFlag;
}
# 531 "../../../../Library/StdDriver/src/i2c.c"
void I2C_SMBusSetPacketByteCount(I2C_T *i2c, uint32_t u32PktSize)
{
    i2c->PKTSIZE = u32PktSize;
}
# 545 "../../../../Library/StdDriver/src/i2c.c"
void I2C_SMBusOpen(I2C_T *i2c, uint8_t u8HostDevice)
{
...
# 569 "../../../../Library/StdDriver/src/i2c.c"
void I2C_SMBusClose(I2C_T *i2c)
{

    i2c->BUSCTL = 0x00U;
}
# 584 "../../../../Library/StdDriver/src/i2c.c"
void I2C_SMBusPECTxEnable(I2C_T *i2c, uint8_t u8PECTxEn)
{
    i2c->BUSCTL &= ~(0x1ul << (8));
...
# 624 "../../../../Library/StdDriver/src/i2c.c"
void I2C_SMBusIdleTimeout(I2C_T *i2c, uint32_t us, uint32_t u32Hclk)
{
...
# 655 "../../../../Library/StdDriver/src/i2c.c"
void I2C_SMBusTimeout(I2C_T *i2c, uint32_t ms, uint32_t u32Pclk)
{
...
# 690 "../../../../Library/StdDriver/src/i2c.c"
void I2C_SMBusClockLoTimeout(I2C_T *i2c, uint32_t ms, uint32_t u32Pclk)
{
    uint32_t u32Div, u32Pclk_kHz;
...
# 730 "../../../../Library/StdDriver/src/i2c.c"
uint8_t I2C_WriteByte(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t data)
{
...
# 760 "../../../../Library/StdDriver/src/i2c.c"
uint32_t I2C_WriteMultiBytes(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t data[], uint32_t u32wLen)
{
...
# 854 "../../../../Library/StdDriver/src/i2c.c"
uint8_t I2C_WriteByteOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, uint8_t data)
{
...
# 886 "../../../../Library/StdDriver/src/i2c.c"
uint32_t I2C_WriteMultiBytesOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, uint8_t data[], uint32_t u32wLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
    uint32_t u32txLen = 0u, u32TimeOutCount = 0u;
...
# 983 "../../../../Library/StdDriver/src/i2c.c"
uint8_t I2C_WriteByteTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, uint8_t data)
{
...
# 1015 "../../../../Library/StdDriver/src/i2c.c"
uint32_t I2C_WriteMultiBytesTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, uint8_t data[], uint32_t u32wLen)
{
...
# 1113 "../../../../Library/StdDriver/src/i2c.c"
uint8_t I2C_ReadByte(I2C_T *i2c, uint8_t u8SlaveAddr)
{
    uint8_t data;
...
# 1145 "../../../../Library/StdDriver/src/i2c.c"
uint32_t I2C_ReadMultiBytes(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t rdata[], uint32_t u32rLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
...
# 1254 "../../../../Library/StdDriver/src/i2c.c"
uint8_t I2C_ReadByteOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr)
{
    uint8_t data;
...
# 1286 "../../../../Library/StdDriver/src/i2c.c"
uint32_t I2C_ReadMultiBytesOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, uint8_t rdata[], uint32_t u32rLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
    uint32_t u32rxLen = 0u, u32TimeOutCount = 0u;
...
# 1413 "../../../../Library/StdDriver/src/i2c.c"
uint8_t I2C_ReadByteTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr)
{
    uint8_t data;
...
# 1445 "../../../../Library/StdDriver/src/i2c.c"
uint32_t I2C_ReadMultiBytesTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, uint8_t rdata[], uint32_t u32rLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Addr = 1u, u8Ctrl = 0u;
    uint32_t u32rxLen = 0u, u32TimeOutCount = 0u;
