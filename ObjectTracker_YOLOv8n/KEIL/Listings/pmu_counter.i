# 1 "../ProfilerCounter/pmu_counter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../ProfilerCounter/pmu_counter.c" 2
# 26 "../ProfilerCounter/pmu_counter.c"
# 1 "C:\\Users\\antia\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdbool.h" 1 3
# 27 "../ProfilerCounter/pmu_counter.c" 2
...
# 28 "../ProfilerCounter/pmu_counter.c" 2
...
# 30 "../ProfilerCounter/pmu_counter.c" 2
...
# 32 "../ProfilerCounter/pmu_counter.c" 2
...
# 34 "../ProfilerCounter/pmu_counter.c" 2




static uint64_t s_u64CPUCycleCount = 0;
static _Bool s_bSysTickInit = 0;
extern uint32_t SystemCoreClock;


static _Bool add_pmu_counter(uint64_t value,
                            const char *name,
                            const char *unit,
                            pmu_counters *counters)
{
    ...
    printf("ERROR - "); printf("Failed to add PMU counter!\n");
    return 0;
}
...
static uint64_t Get_SysTick_Cycle_Count(void)
{
    ...
    systick_val = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL & (0xFFFFFFUL );
    __NVIC_EnableIRQ(SysTick_IRQn);
    return s_u64CPUCycleCount + (((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD - systick_val);
}
...
static int Init_SysTick(void)
{
    ...
    while (!err && !((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL)
    {
        __nop();
    }
...
void SysTick_Handler(void)
{
    ...
    s_u64CPUCycleCount += ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD + 1;
    __builtin_arm_dsb(0xF);
    __builtin_arm_isb(0xF);
}
...
{
    s_u64CPUCycleCount = (uint64_t)u32CurrentTickCnt * (((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD + 1);
}
...
void pmu_reset_counters(void)
{
    if (0 != Init_SysTick())
    {
        printf("ERROR - "); printf("Failed to initialise system tick config\n");
        return;
    }
