...
# 10 "../ModelFileReader.c" 2
# 1 "..\\ModelFileReader.h" 1
# 20 "..\\ModelFileReader.h"
...
)
{
    ...
    res = f_open(&modelFileObject, (const TCHAR *)pszOutFileName, 0x00 | 0x01);
...
)
{
 ...
 if (((int)((&modelFileObject)->fptr == (&modelFileObject)->obj.objsize)))
  return -1;
...
ModelFileReader_FileSize(VOID)
{
 return ((&modelFileObject)->obj.objsize);
}

VOID
ModelFileReader_Rewind(VOID)
{
 f_lseek((&modelFileObject), 0);
}
