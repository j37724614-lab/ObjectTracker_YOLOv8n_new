# 1 "../../../../Library/StdDriver/src/sdh.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/sdh.c" 2
# 10 "../../../../Library/StdDriver/src/sdh.c"
...
# 11 "../../../../Library/StdDriver/src/sdh.c" 2
...
# 12 "../../../../Library/StdDriver/src/sdh.c" 2
...
# 13 "../../../../Library/StdDriver/src/sdh.c" 2
...
# 14 "../../../../Library/StdDriver/src/sdh.c" 2
# 34 "../../../../Library/StdDriver/src/sdh.c"
static uint32_t _SDH0_ReferenceClock, _SDH1_ReferenceClock;




__attribute__((section(".bss.NonCacheable.ZeroInit"))) static uint8_t _SDH0_ucSDHCBuffer[(512ul)] __attribute__((aligned(4))) = {0} ;
__attribute__((section(".bss.NonCacheable.ZeroInit"))) static uint8_t _SDH1_ucSDHCBuffer[(512ul)] __attribute__((aligned(4))) = {0} ;
...
void *SDH_GetSDInfoMsg(SDH_T *sdh)
{
    if (sdh == ((SDH_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x06000UL)))
    {
        return &SD0;
    }
    else if (sdh == ((SDH_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x07000UL)))
    {
        return &SD1;
    }
...
int32_t SDH_CheckRB(SDH_T *sdh)
{
    ...
    i32TimeOutCount2 = (int32_t)2000000;

    while (1)
    {
        sdh->CTL |= (0x1ul << (6));
        i32TimeOutCount1 = (int32_t)2000000;

        while ((sdh->CTL & (0x1ul << (6))) == (0x1ul << (6)))
        {
            if (--i32TimeOutCount1 == 0)
            {
                pSD->i32ErrCode = (int32_t)(((0xFFFF0100ul) | 0x01ul));
                break;
            }
        }

        if ((sdh->INTSTS & (0x1ul << (7))) == (0x1ul << (7)))
        {
            break;
        }
...
uint32_t SDH_SDCommand(SDH_T *sdh, uint32_t u32Cmd, uint32_t u32Arg)
{
    ...
    SDH_INFO_T *pSD;
    int32_t i32TimeOutCount = (int32_t)2000000;
    ...
    sdh->CMDARG = u32Arg;
    u32Buf = (sdh->CTL & (~(0x3ful << (8)))) | (u32Cmd << 8ul) | ((0x1ul << (0)));
    sdh->CTL = u32Buf;

    while ((sdh->CTL & (0x1ul << (0))) == (0x1ul << (0)))
    {
        if (pSD->IsCardInsert == 0ul)
        {
            u32Val = ((0xFFFF0100ul) | 0x10ul);
        }
...
uint32_t SDH_SDCmdAndRsp(SDH_T *sdh, uint32_t u32Cmd, uint32_t u32Arg, uint32_t u32NtickCount)
{
    ...
    sdh->CMDARG = u32Arg;
    u32Buf = (sdh->CTL & (~(0x3ful << (8)))) | (u32Cmd << 8ul) | ((0x1ul << (0)) | (0x1ul << (1)));
    sdh->CTL = u32Buf;

    if (u32NtickCount > 0ul)
    {
        while ((sdh->CTL & (0x1ul << (1))) == (0x1ul << (1)))
        {
            if (u32NtickCount-- == 0ul)
            {
                sdh->CTL |= (0x1ul << (14));
    ...
    if (pSD->R7Flag)
    {
        ...
        {
            pSD->R7Flag = 0ul;
            return ((0xFFFF0100ul) | 0x19ul);
        }
    }

    if (!pSD->R3Flag)
    {
        if ((sdh->INTSTS & (0x1ul << (2))) == (0x1ul << (2)))
        {
            return (0ul);
        }
        else
        {
            return ((0xFFFF0100ul) | 0x16ul);
        }
    }
    else
    {
...
uint32_t SDH_SDCmdAndRsp2(SDH_T *sdh, uint32_t u32Cmd, uint32_t u32Arg, uint32_t pu32R2ptr[])
{
    ...
    sdh->CMDARG = u32Arg;
    u32Buf = (sdh->CTL & (~(0x3ful << (8)))) | (u32Cmd << 8) | ((0x1ul << (0)) | (0x1ul << (4)));
    sdh->CTL = u32Buf;

    while ((sdh->CTL & (0x1ul << (4))) == (0x1ul << (4)))
    {
        if (pSD->IsCardInsert == (0UL))
        {
            return ((0xFFFF0100ul) | 0x10ul);
...
static uint32_t SDH_SDCmdAndRspDataIn(SDH_T *sdh, uint32_t u32Cmd, uint32_t u32Arg)
{
    ...
    sdh->CMDARG = u32Arg;
    u32Buf = (sdh->CTL & (~(0x3ful << (8)))) | (u32Cmd << 8ul) |
             ((0x1ul << (0)) | (0x1ul << (1)) | (0x1ul << (2)));

    sdh->CTL = u32Buf;

    i32TimeOutCount = (int32_t)2000000;
    ...
    if ((sdh->INTSTS & (0x1ul << (3))) != (0x1ul << (3)))
    {

        return ((0xFFFF0100ul) | 0x17ul);
    }
...
void SDH_Set_clock(SDH_T *sdh, uint32_t u32SD_clk_khz)
{
    ...
    {
        u32SD_PwrCtl = ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SRCCTL;

        if ((u32SD_PwrCtl & (0x1ul << (3))) != 0x4ul)
        {
        ...
        if (sdh == ((SDH_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x06000UL)))
        {
            u32SD_ClkSrc = (((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHSEL & (0x7ul << (0)));
            ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHSEL = (((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHSEL & ~(0x7ul << (0))) | (0x3UL << (0));
            _SDH0_ReferenceClock = ((12000000UL) / 1000ul);
        }
        else
        {
            u32SD_ClkSrc = (((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHSEL & (0x7ul << (4)));
            ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHSEL = (((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHSEL & ~(0x7ul << (4))) | (0x3UL << (4));
            _SDH1_ReferenceClock = ((12000000UL) / 1000ul);
        }
    }
    ...
    else
    {
        ...
        if (sdh == ((SDH_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x06000UL)))
        {
            ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHSEL = (((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHSEL & ~(0x7ul << (0))) | u32SD_ClkSrc;
            ...
            switch (u32SD_ClkSrc)
            {
                ...
                case (0x4UL << (0)):
                    _SDH0_ReferenceClock = (((48000000UL) / 1000ul) / 4);
                    break;
        ...
        {
            ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHSEL = (((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHSEL & ~(0x7ul << (4))) | u32SD_ClkSrc;
            ...
            switch (u32SD_ClkSrc)
            {
                ...
                case (0x4UL << (4)):
                    _SDH1_ReferenceClock = (((48000000UL) / 1000ul) / 4);
                    break;
    ...
    if (sdh == ((SDH_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x06000UL)))
    {
        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHDIV &= ~(0xfful << (0));
        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHDIV |= (u32Div1 << (0));
    }
    else
    {
        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHDIV &= ~(0xfful << (8));
        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SDHDIV |= (u32Div1 << (8));
    }
...
uint32_t SDH_CardDetection(SDH_T *sdh)
{
    ...
    if ((sdh->INTEN & (0x1ul << (30))) == (0x1ul << (30)))
    {
        sdh->CTL &= ~(0x1ul << (7));

        if ((sdh->INTSTS & (0x1ul << (16))) == (0x1ul << (16)))
        {
            pSD->IsCardInsert = (uint8_t)(0UL);
            u32Val = (0UL);
        }
        else
        {
            pSD->IsCardInsert = (uint8_t)(1UL);
        }
    }
    else if ((sdh->INTEN & (0x1ul << (30))) != (0x1ul << (30)))
    {
        sdh->CTL |= (0x1ul << (7));
...
static uint32_t SDH_Init(SDH_T *sdh)
{
    ...
    if (u32i == (0ul))
    {
        ...
        pSD->R3Flag = 1ul;
        SDH_SDCmdAndRsp(sdh, 41ul, 0x40ff8000ul, u32CmdTimeOut);
        u32Resp = sdh->RESP0;
    ...
    else
    {
        ...
        if (u32i == 2ul)
        {
            ...
            if (SDH_SDCmdAndRsp(sdh, 1ul, 0x40ff8000ul, u32CmdTimeOut) != 2ul)
            {
                u32Resp = sdh->RESP0;
                i32TimeOutCount = (int32_t)2000000;
                ...
                while ((u32Resp & 0x00800000ul) != 0x00800000ul)
                {
                    ...
                    SDH_SDCmdAndRsp(sdh, 1ul, 0x40ff8000ul, u32CmdTimeOut);
                    u32Resp = sdh->RESP0;
            ...
            {
                pSD->CardType = (0ul);
                return ((0xFFFF0100ul) | 0x11ul);
            }
        }
        else if (u32i == 0ul)
        {
            pSD->R3Flag = 1ul;
            SDH_SDCmdAndRsp(sdh, 41ul, 0x00ff8000ul, u32CmdTimeOut);
            u32Resp = sdh->RESP0;
            i32TimeOutCount = (int32_t)2000000;
    ...
    if (pSD->CardType != (0ul))
    {
        ...
        if ((pSD->CardType == (3ul)) || (pSD->CardType == (4ul)))
        {
            if ((u32Status = SDH_SDCmdAndRsp(sdh, 3ul, 0x10000ul, 0ul)) != (0ul))
            {
                return u32Status;
            }
        ...
        {
            if ((u32Status = SDH_SDCmdAndRsp(sdh, 3ul, 0x00ul, 0ul)) != (0ul))
            {
                return u32Status;
            }
            else
...
uint32_t SDH_SwitchToHighSpeed(SDH_T *sdh, SDH_INFO_T *pSD)
{
    ...
    if ((u32Status = SDH_SDCmdAndRspDataIn(sdh, 6ul, 0x00ffff01ul)) != (0ul))
    {
        return (1ul);
    }
    ...
    if (!busy_status0)
    {
        ...
        if ((u32Status = SDH_SDCmdAndRspDataIn(sdh, 6ul, 0x80ffff01ul)) != (0ul))
        {
            return (1ul);
        }
...
uint32_t SDH_SelectCardType(SDH_T *sdh)
{
    ...
    if ((u32Status = SDH_SDCmdAndRsp(sdh, 7ul, pSD->RCA, 0ul)) != (0ul))
    {
        return u32Status;
    }

    if (SDH_CheckRB(sdh) != (0ul))
    {
        return (((0xFFFF0100ul) | 0x01ul));
    }
    ...
    if (pSD->CardType == (1ul))
    {
        ...
        if ((u32Status = SDH_SDCmdAndRsp(sdh, 55ul, pSD->RCA, 0ul)) != (0ul))
        {
            return u32Status;
        }

        if ((u32Status = SDH_SDCmdAndRspDataIn(sdh, 51ul, 0x00ul)) != (0ul))
        {
            return u32Status;
        }
        ...
        if ((u32Status = SDH_SDCmdAndRsp(sdh, 6ul, 0x02ul, 0ul)) != (0ul))
        {
            return u32Status;
        }
    ...
    else if ((pSD->CardType == (3ul)) || (pSD->CardType == (4ul)))
    {
        ...
        if ((u32Status = SDH_SDCmdAndRsp(sdh, 6ul, u32Param, 0ul)) != (0ul))
        {
            return u32Status;
        }
    ...
    if ((u32Status = SDH_SDCmdAndRsp(sdh, 16ul, (512ul), 0ul)) != (0ul))
    {
        return u32Status;
    }
...
void SDH_Get_SD_info(SDH_T *sdh)
{
    ...
    if ((pSD->CardType == (3ul)) || (pSD->CardType == (4ul)))
    {
        ...
        if ((au32Buffer[0] & 0xc0000000) == 0xc0000000)
        {
            ...
            if (SDH_SDCmdAndRspDataIn(sdh, 8ul, 0x00ul) == (0ul))
            {
                SDH_SDCommand(sdh, 7ul, 0ul);
                sdh->CTL |= (0x1ul << (6));
...
# 1189 "../../../../Library/StdDriver/src/sdh.c"
void SDH_Open(SDH_T *sdh, uint32_t u32CardDetSrc)
{
    int32_t i32TimeOutCount;
    volatile int u32i;
    ...
    while ((sdh->DMACTL & (0x1ul << (1))) == (0x1ul << (1)))
    {
        if (--i32TimeOutCount <= 0)
        {
            pSD->i32ErrCode = (int32_t)(((0xFFFF0100ul) | 0x01ul));
    ...
    sdh->GCTL = (0x1ul << (0)) | (0x1ul << (1));
    i32TimeOutCount = (int32_t)2000000;

    while ((sdh->GCTL & (0x1ul << (0))) == (0x1ul << (0)))
    {
        if (--i32TimeOutCount <= 0)
        {
            pSD->i32ErrCode = (int32_t)(((0xFFFF0100ul) | 0x01ul));
    ...
    if (sdh == ((SDH_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x06000UL)))
    {
        __NVIC_EnableIRQ(SDH0_IRQn);
        memset(&SD0, 0, sizeof(SDH_INFO_T));
        SD0.dmabuf = _SDH0_ucSDHCBuffer;
    }
    else if (sdh == ((SDH_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x07000UL)))
    {
        __NVIC_EnableIRQ(SDH1_IRQn);
    ...
    while ((sdh->CTL & (0x1ul << (14))) == (0x1ul << (14)))
    {
        if (--i32TimeOutCount <= 0)
        {
            pSD->i32ErrCode = (int32_t)(((0xFFFF0100ul) | 0x01ul));
...
void SDH_Close(SDH_T *sdh)
{
    ...
    if (sdh == ((SDH_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x06000UL)))
    {
        __NVIC_DisableIRQ(SDH0_IRQn);
    }
    else if (sdh == ((SDH_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x07000UL)))
    {
        __NVIC_DisableIRQ(SDH1_IRQn);
    }
    else
    {
    }
}
# 1320 "../../../../Library/StdDriver/src/sdh.c"
uint32_t SDH_Probe(SDH_T *sdh)
{
    uint32_t u32Val;
    ...
    if ((SD0.CardType == (3ul)) || (SD1.CardType == (3ul)))
    {
        SDH_Set_clock(sdh, (20000ul));
    }
    else
    {
        SDH_Set_clock(sdh, (25000ul));
    }
...
static uint32_t _SDH_Read(SDH_T *sdh, uint8_t *pu8BufAddr, uint32_t u32StartSec, uint32_t u32SecCount)
{
    ...
    if (u32SecCount == 0ul)
    {
        return ((0xFFFF0100ul) | 0x13ul);
    }

    if ((status = SDH_SDCmdAndRsp(sdh, 7ul, pSD->RCA, 0ul)) != (0ul))
    {
        return status;
    }
    ...
    sdh->BLEN = blksize - 1ul;

    if ((pSD->CardType == (1ul)) || (pSD->CardType == (4ul)))
    {
    ...
    {
        pSD->DataReadyFlag = (uint8_t)(0UL);
        u32Reg = sdh->CTL & ~(0x3ful << (8));
        u32Reg = u32Reg | 0xff0000ul;

        if (u32BIsSendCmd == (0UL))
        {
            sdh->CTL = u32Reg | (18ul << 8) | ((0x1ul << (0)) |
                                               (0x1ul << (1)) |
                                               (0x1ul << (2)));
            u32BIsSendCmd = (1UL);
        }
    ...
    if (SDH_SDCmdAndRsp(sdh, 12ul, 0ul, 0ul))
    {
        return ((0xFFFF0100ul) | 0x16ul);
    }
...
# 1548 "../../../../Library/StdDriver/src/sdh.c"
uint32_t SDH_Read(SDH_T *sdh, uint8_t *pu8BufAddr, uint32_t u32StartSec, uint32_t u32SecCount)
{
    uint32_t u32DrvRet;


    if ((uint32_t)pu8BufAddr % (32U))
    {
        uint8_t *pu8NCBuffer;
        uint32_t u32i = 0;
        ...
        while (u32i < u32SecCount)
        {
            ...
            memcpy(pu8BufAddr + (u32i * (512ul)), pu8NCBuffer, (512ul));
    ...
    else
    {
        ...
        SCB_InvalidateDCache_by_Addr((void *)pu8BufAddr, (int32_t)(u32SecCount * (512ul)));
...
static uint32_t _SDH_Write(SDH_T *sdh, uint8_t *pu8BufAddr, uint32_t u32StartSec, uint32_t u32SecCount)
{
    ...
    for (u32i = 0ul; u32i < u32Loop; u32i++)
    {
        ...
        if ((sdh->INTSTS & (0x1ul << (1))) != 0ul)
        {
            sdh->INTSTS = (0x1ul << (1));
            return ((0xFFFF0100ul) | 0x18ul);
        }
    }
...
# 1780 "../../../../Library/StdDriver/src/sdh.c"
uint32_t SDH_Write(SDH_T *sdh, uint8_t *pu8BufAddr, uint32_t u32StartSec, uint32_t u32SecCount)
{
    uint32_t u32DrvRet;
    ...
    if ((uint32_t)pu8BufAddr % (32U))
    {
        ...
        while (u32i < u32SecCount)
        {
            ...
            memcpy(puNCBuffer, pu8BufAddr + (u32i * (512ul)), (512ul));
    ...
    else
    {
        ...
        SCB_CleanDCache_by_Addr((void *)pu8BufAddr, (int32_t)(u32SecCount * (512ul)));
