# 1 "../NPU/ethosu_cpu_cache.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../NPU/ethosu_cpu_cache.c" 2
# 18 "../NPU/ethosu_cpu_cache.c"
# 1 "../NPU\\ethosu_cpu_cache.h" 1
# 20 "../NPU\\ethosu_cpu_cache.h"
...
# 22 "../NPU\\ethosu_cpu_cache.h" 2
# 32 "../NPU\\ethosu_cpu_cache.h"
...
void ethosu_invalidate_dcache(uint32_t *p, size_t bytes)
{
    if (((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->CCR & (1UL << 16U))
    {
        if (p)
        {
