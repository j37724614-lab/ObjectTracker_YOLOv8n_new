# 1 "../Device/HyperRAM/hyperram_code.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Device/HyperRAM/hyperram_code.c" 2
...
# 9 "../Device/HyperRAM/hyperram_code.c" 2
# 1 "C:\\Users\\antia\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdlib.h" 1 3
# 91 "C:\\Users\\antia\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdlib.h" 3
...
# 589 "C:\\Users\\antia\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdlib.h" 3
extern __attribute__((__nothrow__)) __attribute__((__const__)) ldiv_t ldiv(long int , long int );
# 610 "C:\\Users\\antia\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdlib.h" 3
extern __attribute__((__nothrow__)) __attribute__((__const__)) long long llabs(long long );
# 620 "C:\\Users\\antia\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdlib.h" 3
extern __attribute__((__nothrow__)) __attribute__((__const__)) lldiv_t lldiv(long long , long long );
# 644 "C:\\Users\\antia\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdlib.h" 3
...
# 10 "../Device/HyperRAM/hyperram_code.c" 2
...
# 11 "../Device/HyperRAM/hyperram_code.c" 2
...
# 13 "../Device/HyperRAM/hyperram_code.c" 2
# 1 "../Device/include\\hyperram_code.h" 1
# 17 "../Device/include\\hyperram_code.h"
typedef struct
{
    union
    {
...
# 14 "../Device/HyperRAM/hyperram_code.c" 2
# 37 "../Device/HyperRAM/hyperram_code.c"
void SPIM_Hyper_DefaultConfig(SPIM_T *spim, uint32_t u32CSM, uint32_t u32AcctRD, uint32_t u32AcctWR)
{
    ...
    uint32_t u32DIV = ((spim->CTL1 & (0xfffful << (16))) >> (16));
    uint32_t u32CipherEn = ((spim->CTL0 & (0x1ul << (0))) >> (0));
    uint32_t u32CSMAXLT = ((uint32_t)(u32CSM / fFreq)) - (2 * 8 * u32DIV) - ((u32CipherEn == (0x01UL)) ? 21 : 54);


    do { uint32_t _u32CSST = (((0x0)) < (0x0)) ? (0x0) : (((0x0)) > (0x1)) ? (0x1) : ((0x0)); (spim)->HYPER_CONFIG1 = ((spim)->HYPER_CONFIG1 & ~(0x3ul << (0))) | ((_u32CSST) << (0)); } while (0);


    do { uint32_t u32CSH = (((0x3)) < (0x2)) ? (0x2) : (((0x3)) > (0x3)) ? (0x3) : ((0x3)); (spim)->HYPER_CONFIG1 = ((spim)->HYPER_CONFIG1 & ~((0x3ul << (4)))) | (u32CSH << (4)); } while (0);


    do { uint32_t u32CSHI = ((4) < (0x03)) ? (0x03) : ((4) > (0x0F)) ? (0x0F) : (4); (spim)->HYPER_CONFIG1 = (((spim)->HYPER_CONFIG1 & ~((0xful << (8)))) | ((u32CSHI) << (8))); }while(0);


    (spim->HYPER_CONFIG1 = ((spim->HYPER_CONFIG1 & ~((0xffffful << (12)))) | (((u32CSMAXLT) - 1) << (12))));


    (spim->HYPER_CONFIG2 = ((spim->HYPER_CONFIG2 & ~((0xfful << (16)))) | ((0xFF) << (16))));


    (spim->HYPER_CONFIG2 = ((spim->HYPER_CONFIG2 & ~((0x1ful << (24)))) | ((u32AcctRD) << (24))));


    (spim->HYPER_CONFIG2 = ((spim->HYPER_CONFIG2 & ~((0x1ful << (8)))) | ((u32AcctWR) << (8))));
}
# 74 "../Device/HyperRAM/hyperram_code.c"
void HyperRAM_Erase(SPIM_T *spim, uint32_t u32StartAddr, uint32_t u32EraseSize)
{
    uint16_t u16Data;
    uint32_t u32i = 0;
...
# 118 "../Device/HyperRAM/hyperram_code.c"
uint8_t isConsecutive(uint8_t au8Src[], uint32_t size)
{
    ...
    _Bool increasing = au8Src[1] > au8Src[0];
...
void HyperRAM_TrimDLLDelayNumber(SPIM_T *spim)
{
    ...
    uint8_t u8RdDelay = 0;
    uint8_t u8RdDelayRes[(0x20)] = {0};
    uint32_t u32PatternSize = 128;
    ...
    uint64_t au64TrimPattern[(128 * 2) / 8] = {0};
    uint64_t au64VerifyBuf[128 / 8] = {0};
    ...
    {
        for (u8RdDelay = 0; u8RdDelay < (0x20); u8RdDelay++)
        {

            SPIM_HYPER_SetDLLDelayNum(spim, u8RdDelay);

            memset(pu8VerfiyBuf, 0, 128);
            ...
            for (u32k = 0; u32k < u32PatternSize; u32k += 0x08)
            {
                ...
                SCB_InvalidateDCache_by_Addr((volatile uint32_t *)((u32ReTrimCnt == 1) ? u32SrcAddr : (u32DMMAddr + u32SrcAddr)), (int32_t)128 * 2);
...
void HyperRAM_Init(SPIM_T *spim)
{
    ...
    CLK_EnableModuleClock(((((47ULL) & 0xffUL) << 47)|((((uint64_t)(0)) & 0x1fUL) << 10)| (((0x0ULL) & 0xffUL) << 39)|(((0x0ULL) & 0xffUL) << 23)|(((0x0ULL) & 0x1fUL) << 5)| (((0x0ULL) & 0xffUL) << 31)|(((0x0ULL) & 0xffUL) << 15)|(((0x0ULL) & 0x1fUL) << 0)));


    SYS_LockReg();


    SPIM_HYPER_Init(spim, (0x01), 1);


    SPIM_HYPER_DISABLE_CIPHER(spim);


    SPIM_Hyper_DefaultConfig(spim, 4000, 7, 7);
    ...
    sHRAMReg.CONFIG0.u32REG = SPIM_HYPER_ReadHyperRAMReg(spim, (0x00001000));
# 302 "../Device/HyperRAM/hyperram_code.c"
    sHRAMReg.CONFIG0.u3DriveStrength = 0;


    SPIM_HYPER_WriteHyperRAMReg(spim, (0x00001000), sHRAMReg.CONFIG0.u32REG);

}

void HyperRAM_PinConfig(SPIM_T *spim)
{
    if (spim == ((SPIM_T *) ((((uint32_t) 0x40000000UL) + 0x00040000UL) + 0x02000UL)))
    {
        ...
        CLK_EnableModuleClock(((((37ULL) & 0xffUL) << 47)|((((uint64_t)(0)) & 0x1fUL) << 10)| (((0x0ULL) & 0xffUL) << 39)|(((0x0ULL) & 0xffUL) << 23)|(((0x0ULL) & 0x1fUL) << 5)| (((0x0ULL) & 0xffUL) << 31)|(((0x0ULL) & 0xffUL) << 15)|(((0x0ULL) & 0x1fUL) << 0)));
        ...
        uint32_t u32SlewRate = 0x3UL;

        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPH_MFP3 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPH_MFP3 & (~(0x1ful << (0)))) | (0xCUL<<(0)));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPH_MFP3 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPH_MFP3 & (~(0x1ful << (8)))) | (0xCUL<<(8)));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPJ_MFP1 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPJ_MFP1 & (~(0x1ful << (8)))) | (0xCUL<<(8)));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPJ_MFP1 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPJ_MFP1 & (~(0x1ful << (16)))) | (0xCUL<<(16)));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPH_MFP3 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPH_MFP3 & (~(0x1ful << (16)))) | (0xCUL<<(16)));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPH_MFP3 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPH_MFP3 & (~(0x1ful << (24)))) | (0xCUL<<(24)));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPG_MFP3 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPG_MFP3 & (~(0x1ful << (8)))) | (0xCUL<<(8)));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPG_MFP3 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPG_MFP3 & (~(0x1ful << (16)))) | (0xCUL<<(16)));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPJ_MFP1 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPJ_MFP1 & (~(0x1ful << (0)))) | (0xCUL<<(0)));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPJ_MFP0 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPJ_MFP0 & (~(0x1ful << (24)))) | (0xCUL<<(24)));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPJ_MFP0 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPJ_MFP0 & (~(0x1ful << (16)))) | (0xCUL<<(16)));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPG_MFP3 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPG_MFP3 & (~(0x1ful << (24)))) | (0xCUL<<(24)));
        ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPJ_MFP1 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPJ_MFP1 & (~(0x1ful << (24)))) | (0xCUL<<(24)));

        ((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29180UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29180UL)))->SMTEN |= ((0x1ul << (13)) |
                      (0x1ul << (14)) |
                      (0x1ul << (15)));
        ((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL)))->SMTEN |= ((0x1ul << (12)) |
                      (0x1ul << (13)) |
                      (0x1ul << (14)) |
                      (0x1ul << (15)));
        ((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL)))->SMTEN |= ((0x1ul << (2)) |
                      (0x1ul << (3)) |
                      (0x1ul << (4)) |
                      (0x1ul << (5)) |
                      (0x1ul << (6)) |
        ...
        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29180UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29180UL))), (0x00002000UL), u32SlewRate);
        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29180UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29180UL))), (0x00004000UL), u32SlewRate);
        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29180UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29180UL))), (0x00008000UL), u32SlewRate);

        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL))), (0x00001000UL), u32SlewRate);
        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL))), (0x00002000UL), u32SlewRate);
        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL))), (0x00004000UL), u32SlewRate);
        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL))), (0x00008000UL), u32SlewRate);

        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL))), (0x00000004UL), u32SlewRate);
        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL))), (0x00000008UL), u32SlewRate);
        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL))), (0x00000010UL), u32SlewRate);
        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL))), (0x00000020UL), u32SlewRate);
        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL))), (0x00000040UL), u32SlewRate);
        GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29240UL))), (0x00000080UL), u32SlewRate);
    }
}
